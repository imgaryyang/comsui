...
public class DailyGuaranteeServiceImplTest {
    @Autowired
    ...
    @Test
    @Sql("classpath:/test/test4ExecuteDailyGuaranteeJob.sql")
    public void test_executeDailyGuaranteeJob() throws ParseException {
        String financialContractUuid = "d2812bc5-5057-4a91-b3fd-9019506f0499";
        Date doingDay = DateUtils.parseDate("2017-12-25", "yyyy-MM-dd");

        dailyGuaranteeService.executeDailyGuaranteeJob(financialContractUuid, doingDay);

        Map<String, Object> parameters = new HashMap<>();
        parameters.put("financialContractUuid", financialContractUuid);
        parameters.put("createDate", doingDay);

        String resultQuery = "select amount from daily_guarantee "
