package com.suidifu.morganstanley.controller.task;

import com.demo2do.core.utils.JsonUtils;
import com.suidifu.morganstanley.tasks.BasicTask;
...
public class TaskController {
	...
	public String show(HttpServletResponse response) {
		try {
			List<DynamicBusinessTask> tasks = dynamicBusinessTaskService.getDynamicBusinessTaskListByServerGroup(DynamicBusinessTask.SERVER_GROUP_MORGANSTANLEY);
	...
	public String startup(HttpServletResponse response){
		try {
			...
			synchronized(this) {
				...
				List<DynamicBusinessTask> dbTasks = dynamicBusinessTaskService.getDynamicBusinessTaskListByServerGroup(DynamicBusinessTask.SERVER_GROUP_MORGANSTANLEY);
	...
	public String list(HttpServletResponse response) {
		try {
			...
			return jsonViewResolver.sucJsonResult("taskWorkStatus", taskWorkStatus);
		} catch (Exception e) {
