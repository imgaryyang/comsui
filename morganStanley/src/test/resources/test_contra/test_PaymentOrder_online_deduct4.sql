...
VALUES
  (1, 1, 3, '2016-04-01 00:00:00', 'G08200', '测试合同', 1, 1, 91, '2016-07-01 00:00:00', 1, 0, 1, 90, 2, '74a9ce4d-cafc-407d-b013-987077541bdc',
                                                                                         'financial_contract_uuid_1', 1, 1, 1, 1, 0, 1, NULL, NULL, NULL, NULL, 1, 0,
                                                                                                                                  0, 0,
    '(principal+interest)*0.05/100*overdueDay', 123.00, 23.00, NULL, NULL, '2017-03-16 22:56:48', 1, 0,
    'outstandingPrincipal+outstandingInterest+outstandingPenaltyInterest', 30, 0, 'outstandingPrincipal', 'outstandingInterest', 'outstandingPenaltyInterest', NULL,
                                                                               -1, 0, NULL, NULL, NULL);
...
VALUES
  ('4', 'financial_contract_uuid_1', '0', 'f2591e61-735e-11e6-bf08-00163e002839,16ea0d08-735f-11e6-bf08-00163e002839',
        'f2591e61-735e-11e6-bf08-00163e002839,16ea0d08-735f-11e6-bf08-00163e002839', '0', '0', 'f2591e61-735e-11e6-bf08-00163e002839',
        '16ea0d08-735f-11e6-bf08-00163e002839', NULL, NULL);
...
VALUES
  ('6', 'financial_contract_uuid_1', '测试合同', '16ea0d08-735f-11e6-bf08-00163e002839', 'G31700平安银企直联', '0', '600000000001', '2016-09-02 00:00:00',
        '2016-09-05 19:53:39', '1', '1', 'f8bb9956-1952-4893-98c8-66683d25d7ce', 'f8bb9956-1952-4893-98c8-66683d25d7ce', '1',
   '{\"complete\":false,\"creditChannelConfigure\":{\"channelStatus\":\"ON\",\"chargeExcutionMode\":\"BACKWARD\",\"chargePerTranscation\":0,\"chargeRateMode\":\"SINGLEFIXED\",\"clearingInterval\":0,\"trasncationLimitPerTransaction\":100,\"valid\":true},\"debitChannelConfigure\":{\"channelStatus\":\"NOTLINK\",\"clearingInterval\":0,\"trasncationLimitPerTransaction\":100,\"valid\":true}}',
   NULL, '0');
...
VALUES
  ('1', '测试通道1', 'operator', 'operator', '001053110000001', '/data/webapps/tomcat-earth/webapps/earth/WEB-INF/classes/certificate/gzdsf.cer',
        '/data/webapps/tomcat-earth/webapps/earth/WEB-INF/classes/certificate/ORA@TEST1.pfx', '123456', '0', 'http://59.41.103.98:333/gzdsf/ProcessServlet', NULL,
   NULL);
...
VALUES
  (1, 'contract_uuid_1', 'contract_unique_id_1', '2015-10-19', 'contract_no', '2016-10-19', 1, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 1000, 0.0001, 1,
   'financial_contract_uuid_1');

INSERT INTO `contract_account` (`id`, `pay_ac_no`, `bankcard_type`, `contract_id`, `payer_name`, `bank`, `bind_id`, `id_card_num`, `bank_code`, `province`, `city`, `from_date`, `thru_date`, `contract_account_type`)
VALUES
...
VALUES
  (10, 'order_uuid_1', 'orderUniqueId', 'merId', 'e573be60-f16c-4918-9e8c-b220561b9282', 0, 0, 1, 0, 0, 0, 0, 0.00, 1000.00, '2017-06-12 17:40:39',
                                                                                                           '2017-06-12 17:40:39', '', '127.0.0.1',
                                                                                                           'financial_contract_uuid_1', 'G08200', '测试合同',
   '/home/dell/Desktop/repaymentOrderDetails/repayment_order_1497260439015062c99f4-ee0c-46ee-af5c-019ed8635eea.csv', 'empty', '', 'contract_uuid_1');
