...
VALUES 
		('24', '1234567890', '123456', '2016-04-17', '629测试(ZQ2016002000001)', NULL, 
...
INSERT INTO  `asset_set` (`id`, `guarantee_status`, `settlement_status`, `asset_fair_value`, `asset_principal_value`, `asset_interest_value`, 
		...
		`version_no`, `active_status`,`financial_contract_uuid`,`contract_uuid`) 
VALUES 
		('24', '1', '0', '200.20', '0.00', '200.00', 
		'200.00', DATE_SUB(DATE(Now()), INTERVAL 3 DAY), NULL, '0.00', '0', '1',
		...
		'1', '0','984149f1-cb43-410c-a789-d8f4bba123b6','1234567890');
