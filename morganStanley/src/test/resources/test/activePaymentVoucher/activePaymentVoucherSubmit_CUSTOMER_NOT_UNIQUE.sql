...
-- INSERT INTO account (account_name, account_no, bank_name, alias, attr, scan_cash_flow_switch, usb_key_configured, uuid, bank_code, cash_flow_config) VALUES
-- ('银企直连专用账户9', '591902896710201', '工商银行', null, '{"bankBranchNo":"59","usbUuid":"b173f24a-3c27-4243-85b7-e93ef6a128ac"}', true, true, 'uuid_5', 'PAB', '{"nextPageNo":"1"}');
...
INSERT INTO contract (uuid, unique_id, begin_date, contract_no, end_date, asset_type, month_fee, app_id, customer_id, house_id, actual_end_date, create_time, interest_rate, payment_day_in_month, payment_frequency, periods, repayment_way, total_amount, penalty_interest, active_version_no, repayment_plan_operate_logs, state, financial_contract_uuid, interest_rate_cycle, customer_uuid) VALUES
('a0afea67-5fa8-11e6-b2c2-00163e002839', null, '2016-04-17', '2016-78-DK(ZQ2016000000001)', null, 1, 0.00, 1, 122, 283, null, '2016-06-02 20:12:45', 0.1560000000, 0, 0, 1, 2, 1200.00, 0.0005000000, 1, null, 2, '2d380fe1-7157-490d-9474-12c5a9901e29', 0, 'be1c9a96-9426-481b-acb9-27092daf7895');
...
INSERT INTO customer (id, account, mobile, name, source, app_id, customer_uuid, customer_type, customer_style, status, id_type) VALUES
(122, '410402198801115650', null, '测试用户1', 'C74211', 1, 'be1c9a96-9426-481b-acb9-27092daf7895', 0, 0, 1, 0);
