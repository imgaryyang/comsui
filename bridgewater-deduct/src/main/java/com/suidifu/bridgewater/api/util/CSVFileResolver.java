...
public class CSVFileResolver {
	...
	public CSVFileResolver(String filename, String encoding) throws Exception {
		if (StringUtils.isEmpty(encoding)) {
			encoding = DEFAULT_ENCODE;
		}

		fis = new FileInputStream(filename);
		isw = new InputStreamReader(fis, encoding);
	 ...
	 * @throws Exception
	 */
	public List<List<String>> loadAllLinesOfFile() throws Exception {
		String line = StringUtils.EMPTY;
		List<List<String>> lineDatas = new ArrayList<List<String>>();
		
		while ((line = this.readLine()) != null) {
			
			List<String> lineData = this.fromCSVLinetoArray(line);
