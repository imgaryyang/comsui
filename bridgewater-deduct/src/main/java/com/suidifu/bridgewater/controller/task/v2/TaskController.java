package com.suidifu.bridgewater.controller.task.v2;
...
public class TaskController{
	...
	public String show(HttpServletResponse response) {
		try {
			List<DynamicBusinessTask> tasks = dynamicBusinessTaskService.getDynamicBusinessTaskListByServerGroup(DynamicBusinessTask.SERVER_GROUP_DEDUCT);
	...
	public String startup(HttpServletResponse response){
		try {
			...
			synchronized(this) {
				...
				List<DynamicBusinessTask> dbTasks = dynamicBusinessTaskService.getDynamicBusinessTaskListByServerGroup(DynamicBusinessTask.SERVER_GROUP_DEDUCT);
