...
public class BasicTask implements Runnable {
	...
	{
		put("batchDeductResultCallBackTask", "batchDeductResultCallBackTask");
		put("deductNotifyTask", "deductNotifyTask");
		put("deductQueryTask", "deductQueryTask");
		put("combineNoticeTaskForDeduct", "combineNoticeTaskForDeduct");
