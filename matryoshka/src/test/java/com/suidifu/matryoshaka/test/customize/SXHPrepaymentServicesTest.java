...
import com.suidifu.matryoshaka.test.scripts.SXHPrepaymentServices;
...
@Transactional()
@Rollback(true)
public class SXHPrepaymentServicesTest {
	...
	public void test_charge_change_services_no_data() {
		...
		SXHPrepaymentServices services = new SXHPrepaymentServices();
	...
	// 非佰仟信贷合同不允许变更
	@Test
	@Sql("classpath:test/yunxin/script/test_SXHPrepayment_services_not_allow_freewheeling_repayment.sql")
	public void test_SXHPrepayment_services_not_allow_freewheeling_repayment() {
	...
	// 应还日当日不允许变更
	@Test
	@Sql("classpath:test/yunxin/script/test_SXHPrepayment_services_at_asset_recycle_date.sql")
	public void test_SXHPrepayment_services_at_asset_recycle_date() {
	...
	// 已过应还日不允许变更
	@Test
	@Sql("classpath:test/yunxin/script/test_SXHPrepayment_services_overdue.sql")
	public void test_SXHPrepayment_services_overdue() {
	...
	// 还款成功不可变更
	@Test
	@Sql("classpath:test/yunxin/script/test_SXHPrepayment_services_execute_success.sql")
	public void test_SXHPrepayment_services_execute_success() {
	...
	// 实收>0不允许变更
	@Test
	@Sql("classpath:test/yunxin/script/test_SXHPrepayment_services_have_actual_amount.sql")
	public void test_SXHPrepayment_services_have_actual_amount() {
	...
	@Test
	@Sql("classpath:test/yunxin/script/test_SXHPrepayment_services.sql")
	public void test_SXHPrepayment_services() {
