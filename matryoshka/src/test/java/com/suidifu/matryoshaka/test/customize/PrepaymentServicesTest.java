...
import com.suidifu.matryoshaka.test.scripts.PrepaymentServices;
...
@Transactional()
@Rollback(true)
public class PrepaymentServicesTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void test_charge_change_services_no_data() {
		...
		PrepaymentServices services = new PrepaymentServices();
	...
	// 非佰仟信贷合同不允许变更
	@Test
	@Sql("classpath:test/yunxin/script/test_prepayment_services_not_allow_freewheeling_repayment.sql")
	public void test_prepayment_services_not_allow_freewheeling_repayment() {
	...
	// 应还当日允许变更
	@Test
	@Sql("classpath:test/yunxin/script/test_prepayment_services_at_asset_recycle_date.sql")
	public void test_prepayment_services_at_asset_recycle_date() {
	...
	// 应还当日实收>0不允许变更
	@Test
	@Sql("classpath:test/yunxin/script/test_prepayment_services_at_asset_recycle_date_have_actual_amount.sql")
	public void test_prepayment_services_at_asset_recycle_date_have_actual_amount() {
	...
	// 已过应还日不允许变更
	@Test
	@Sql("classpath:test/yunxin/script/test_prepayment_services_overdue.sql")
	public void test_prepayment_services_overdue() {
	...
	// 还款成功不可变更
	@Test
	@Sql("classpath:test/yunxin/script/test_prepayment_services_execute_success.sql")
	public void test_prepayment_services_execute_success() {
	...
	// 未到期实收>0不允许变更
	@Test
	@Sql("classpath:test/yunxin/script/test_prepayment_services_have_actual_amount.sql")
	public void test_prepayment_services_have_actual_amount() {
	...
	@Test
	@Sql("classpath:test/yunxin/script/test_prepayment_services.sql")
	public void test_prepayment_services() {
