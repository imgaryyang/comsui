...
import com.suidifu.owlman.microservice.exception.TemplatenDontExistException;
...
//	public static String BUSINESS_TYPE;
	...
	public List<Map<String, Object>> parseSection(Map<String, Object> contextFrame,String ledgerBookNo,EventType eventType) {
		String BUSINESS_TYPE = eventType.toString();
		...
		try {
			...
			LOG.info("FastAccountTemplate:signature["+signature+"]");
