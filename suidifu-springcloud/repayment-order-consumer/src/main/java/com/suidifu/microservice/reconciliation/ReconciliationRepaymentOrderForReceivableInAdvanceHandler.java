...
public class ReconciliationRepaymentOrderForReceivableInAdvanceHandler
    ...
    public ReconciliationRepaymentContext preAccountReconciliation(Map<String, Object> inputParams)
        ...
        context.resolveJournalVoucher(AccountSide.DEBIT, counterAccountType,
                getJournalVoucherBillingPlanUuid(item));
        ...
        DepositeAccountInfo unionDepositAccount = bankAccountCache.
                extractThirdPartyPaymentChannelAccountFrom(context.getFinancialContract(), merIdClearingNo);
    ...
    private String getJournalVoucherBillingPlanUuid(RepaymentOrderItem item) {
        return item.getContractUuid() + ":" + item.getCurrentPeriod();
    }
