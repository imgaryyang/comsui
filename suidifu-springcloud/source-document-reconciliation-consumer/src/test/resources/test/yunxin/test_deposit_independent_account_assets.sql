...
INSERT INTO `financial_contract` (`adva_repayment_term`, `id`, `adva_matuterm`, `contract_no`, `contract_name`, `app_id`, `company_id`, `adva_repo_term`, `loan_overdue_end_day`, `loan_overdue_start_day`, `payment_channel_id`, `ledger_book_no`, `asset_package_format`, `financial_contract_type`)
VALUES
  (0, '1', 3, 'DCF-NFQ-LR903A', '云南信托', 1, 1, 30, 90, 1, 1, 'yunxin_ledger_book', 1, 0);
...
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`, `end_date`, `app_id`, `customer_id`, `house_id`, `actual_end_date`, `create_time`, `interest_rate`, `payment_day_in_month`, `payment_frequency`, `periods`, `repayment_way`, `total_amount`, `penalty_interest`, `active_version_no`)
VALUES
  (1, '2015-10-19', 'DKHD-001', '2016-10-19', 1, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 1000, 0.0001,
   1),
  (7, '2015-10-19', 'DKHD-002', '2016-10-19', 1, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 1000, 0.0001,
   1);
...
VALUES
  ('1', 'ledger_uuid_1', '0.00', '900.00', 'FST_LONGTERM_LIABILITY', '40000', '0',
    ...
    '7', NULL, '2016-05-27 00:00:00', '', 'yunxin_ledger_book', '1', '1', 'ZC27304880AB312E3A',
    'd2c21631-f2fb-4e8f-beef-0a2e72447434', NULL, NULL, NULL, NULL, '');

INSERT INTO `asset_set` (`id`, `actual_recycle_date`, `asset_fair_value`, `asset_initial_value`, `asset_interest_value`, `asset_principal_value`, `asset_recycle_date`, `asset_status`, `asset_uuid`, `create_time`, `current_period`, `guarantee_status`, `last_modified_time`, `last_valuation_time`, `on_account_status`, `settlement_status`, `single_loan_contract_no`, `contract_id`, `version_no`, `active_status`)
VALUES
  ('1', NULL, '1000.00', '1000.00', '100.00', '900.00', '2016-05-01', '0', 'd2c21631-f2fb-4e8f-beef-0a2e72447434',
        '2016-05-16 14:26:50', '1', '0', NULL, NULL, '1', '0', 'ZC27304880AB312E3A', '7', 1, 0),
  ('2', NULL, '1000.00', '1000.00', '200.00', '800.00', '2016-05-05', '0', '6100d113-068e-42d4-b4e2-06fd53e96a75',
        '2016-05-16 14:26:50', '2', '0', NULL, NULL, '1', '0', 'ZC27304880AB4AEA99', '7', 1, 0);
