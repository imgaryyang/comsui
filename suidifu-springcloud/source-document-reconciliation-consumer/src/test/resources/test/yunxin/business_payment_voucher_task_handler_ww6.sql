...
INSERT INTO `journal_voucher` (`id`, `account_side`, `bank_identity`, `billing_plan_uuid`, `booking_amount`, `business_voucher_type_uuid`, `business_voucher_uuid`, `cash_flow_amount`, `cash_flow_breif`, `cash_flow_channel_type`, `cash_flow_serial_no`, `cash_flow_uuid`, `checking_level`, `company_id`, `completeness`, `counter_party_account`, `counter_party_name`, `journal_voucher_uuid`, `notification_identity`, `notification_memo`, `notification_record_uuid`, `notified_date`, `settlement_modes`, `source_document_amount`, `source_document_breif`, `source_document_cash_flow_serial_no`, `source_document_counter_party_uuid`, `source_document_identity`, `source_document_uuid`, `status`, `trade_time`, `batch_uuid`, `created_date`, `source_document_counter_party_account`, `source_document_counter_party_name`, `issued_time`, `journal_voucher_type`, `counter_account_type`, `related_bill_contract_info_lv_1`, `related_bill_contract_info_lv_2`, `related_bill_contract_info_lv_3`, `cash_flow_account_info`, `journal_voucher_no`, `related_bill_contract_no_lv_1`, `related_bill_contract_no_lv_2`, `related_bill_contract_no_lv_3`, `related_bill_contract_no_lv_4`, `source_document_no`, `appendix`, `last_modified_time`)
  VALUE
  ('1', '1', '', '113e1f29-856f-4916-82d1-424e32612be2', '1.01', '2b784ef2-a1ab-41fa-b315-8e1bf8cfa2ba', '', '0.00', '',
        NULL, '', '', '0', '1', '1', '6217001210031616480', '韩方园', 'cd0f2929-b4a9-49b5-9712-652465346e74', '', '', '',
    '2016-08-27 15:57:47', NULL, '1.01', '', '', '', '6fbe92ed-674b-436f-96ae-cd71e5cd6ecc',
    'e73e28ee-1dd2-4009-8973-576c038042e4', '0', '2016-08-27 15:57:47', '', '2016-09-21 09:33:46', '20001', '云南信托',
                                                                        '2016-08-27 15:57:47', '7', '0',
                                                                        'b674a323-0c30-4e4b-9eba-b14e05a9d80a',
                                                                        '287c16f2-77cb-4d3a-8f9a-05904b370546',
                                                                        'ef0ae4ed-7a75-4895-a739-a82e2e8930f5', '',
   '8d297098-80c7-11e6-b7d3-00163e002839', '', '', '', 'JS2736C1C9D8B66E34', '', '', '2016-08-27 15:57:47');


INSERT INTO `asset_set` (`contract_uuid`, `id`, `guarantee_status`, `settlement_status`, `asset_fair_value`, `asset_principal_value`, `asset_interest_value`, `asset_initial_value`, `asset_recycle_date`, `confirm_recycle_date`, `refund_amount`, `asset_status`, `on_account_status`, `repayment_plan_type`, `last_valuation_time`, `asset_uuid`, `create_time`, `last_modified_time`, `comment`, `single_loan_contract_no`, `contract_id`, `actual_recycle_date`, `current_period`, `overdue_status`, `overdue_date`, `version_no`, `active_status`, `sync_status`, `active_deduct_application_uuid`, `executing_status`)
VALUES
  ('contract_uuid', '1', '0', '0', '0.01', '0.01', '0.00', '0.01', '2016-01-01', NULL, '0.00', '0', '1', '0', NULL,
                                                                                               'asset_uuid',
                                                                                               '2016-08-27 15:57:47',
                                                                                               '2016-08-27 15:57:47',
                                                                                               NULL,
                                                                                               'ZC2743B948833DA777',
                                                                                               '1', NULL, '2', '0',
   NULL, '1', '0', '0', 'empty_deduct_uuid', '3'),
  ('contract_uuid', '2', '0', '0', '0.01', '0.01', '0.00', '0.01', '2016-01-01', NULL, '0.00', '0', '1', '0', NULL,
                                                                                               'asset_uuid2',
                                                                                               '2016-06-27 15:57:47',
                                                                                               '2016-08-27 15:57:47',
                                                                                               NULL,
...
VALUES
  ('0', '1', '0', '1', '2016-09-01 00:00:00', 'G31700', '拍拍贷测试', '1', '1', '60', '2017-08-31 00:00:00', '1', '0', '1',
                                                                                                        '2', '1',
                                                                                                        'ledger_book_no',
...
VALUES ('1', 'source_document_detail_uuid', 'source_document_uuid', 'unique_id', 'repurchase_doc_uuid', '2700.00', '1',
             'enum.voucher-source.business-payment-voucher', 'ebfdd395-d5aa-4612-b728-0858479317d3',
             'enum.voucher-type.repurchase', '1dfab272-8b75-4439-91e9-af6eabb15670', '0', '6600000000000000001',
                                                                                     '10001', 'counter_name',
                                                                                     'account_account_name', '0', NULL,
                                                                                     NULL, '2100.00', '100.00', '0.00',
        '0.00', '300.00', '200.00', '0.00', '0.00', '0.00', NULL, NULL);
...
VALUES ('1', 'repurchase_doc_uuid', 'financial_contract_uuid', '2200.00', '2016-10-20', '2016-11-03', '3',
             '2016-10-31 20:14:59', '2016-11-01 15:17:55', '2016-10-31 20:14:59', '1', 'G00003(zht36853461685090410)',
                                                                                       '1', '安美途', 'customerUuid1',
                                                                                       'aa', NULL, NULL, '0', NULL,
...
VALUES
  ('1', 'ledger_uuid_1', '0.00', '900.00', 'FST_LONGTERM_LIABILITY', '40000', '0',
    ...
    '7', NULL, '2016-05-27 00:00:00', '', 'ledger_book_no', '1', '1', 'repayment_plan_no_1',
