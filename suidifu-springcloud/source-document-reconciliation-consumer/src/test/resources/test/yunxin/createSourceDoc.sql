...
INSERT INTO `financial_contract` (`adva_repayment_term`, `id`, `adva_matuterm`, `contract_no`, `app_id`, `company_id`, `adva_repo_term`, `capital_account_id`)
VALUES
...
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`, `end_date`, `app_id`, `customer_id`, `house_id`, `actual_end_date`, `create_time`, `interest_rate`, `payment_day_in_month`, `payment_frequency`, `periods`, `repayment_way`, `total_amount`, `penalty_interest`)
VALUES
  (1, '2015-10-19', 'DKHD-001', '2016-10-19', 1, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 1000, 0.0001);


INSERT INTO `rent_order` (`id`, `due_date`, `order_no`, `payout_time`, `total_rent`, `customer_id`, `user_upload_param`, `modify_time`, `asset_set_id`, `create_time`, `clearing_status`, `executing_settling_status`, `financial_contract_id`)
VALUES
...
VALUES
  (1, '10', NULL, 1, NULL, '2015-10-10', 0, 1, '2015-10-10', NULL, 1, 1),
  (2, '10', NULL, 2, NULL, '2015-10-13', 1, 2, '2015-10-13', NULL, 1, 2);
...
VALUES
  ('1', 'uuid1', '10.00', NULL, '', 'serial_no_1', NULL, '', '', '20160323111100'),
  ('2', 'uuid2', '10.00', NULL, '', 'serial_no_2', NULL, '', '', '20160111111100');
