...
public class JournalVoucher {
    ...
    public JournalVoucher createFromContext(ReconciliationContext context) {
        ...
        resovleJournalVoucherParties(context.getJournalVoucherResolver());
    ...
    public JournalVoucher createFromContext(ReconciliationRepaymentContext context) {
        ...
        resovleJournalVoucherParties(context.getResolver());
    ...
    public JournalVoucher compensate_active_payment_info_into_existed_auto_remittance(SourceDocumentDetail sourceDocumentDetail, String sourceDocumentNo, JournalVoucherType journalVoucherType, JournalVoucherResolver journalVoucherResolver, SourceDocument sourceDocument) {
        //TODO 余额支付与主动还款凭证的对应。

        this.sourceDocumentUuid = sourceDocumentDetail.getUuid();
        this.sourceDocumentIdentity = sourceDocumentDetail.getSourceDocumentUuid();
        resovleJournalVoucherParties(journalVoucherResolver);
        this.sourceDocumentNo = sourceDocumentNo;
    ...
    public JournalVoucher compensate_active_payment_info_into_existed_auto_remittance_repayment_order(JournalVoucherType journalVoucherType, JournalVoucherResolver journalVoucherResolver, Date actualRecycleTime, String cashFlowIdentity) {
        //TODO 余额支付与主动还款凭证的对应。
