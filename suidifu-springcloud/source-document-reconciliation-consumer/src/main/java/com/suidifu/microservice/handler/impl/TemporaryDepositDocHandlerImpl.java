...
public class TemporaryDepositDocHandlerImpl implements TemporaryDepositDocHandler {
    ...
    public void businessPayCreateTemporaryDepositDoc(String sourceDocumentUuid,
        ...
        TemporaryDepositDoc temporaryDepositDoc = new TemporaryDepositDoc(AccountSide.CREDIT,
                ...
                TmpDepositStatus.UNCLEAR, virtualAccount.getOwnerUuid(), virtualAccount.getOwnerName(),
                CustomerType.COMPANY, virtualAccount.getUuid(), virtualAccount.getVirtualAccountNo(),
                "", sourceDocument.getFinancialContractUuid(),
                sourceDocument.getVoucherUuid(),
        ...
        //账本转出多余金额,转入滞留单
        LedgerTradeParty independentAccountTradeParty = new LedgerTradeParty(virtualAccount.getOwnerUuid(),
                ""); //customerUuid
        LedgerTradeParty temporaryDepositTradeParty = new LedgerTradeParty(virtualAccount.getOwnerUuid(), "");
        ...
        AssetCategory assetCategory = AssetConvertor.
                convertTemporayDepositDocAssetCategory(temporaryDepositDoc.getUuid(),
                        cashFlow != null ? cashFlow.getCashFlowIdentity() : null);
        ...
        if (ledgerBookV2Handler.checkLegderBookVersion(ledgerBook)) {
            ...
            ledgerBookV2Handler.book_compensatory_remittance_virtual_accountV2(ledgerBook,
                    temporaryDepositTradeParty, independentAccountTradeParty,
                    "", "", sourceDocument.getUuid(),
                    temporaryDepositAmount, assetCategory,
