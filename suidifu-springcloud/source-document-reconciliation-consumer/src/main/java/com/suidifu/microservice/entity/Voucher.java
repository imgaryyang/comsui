...
public class Voucher {
    ...
    public static Voucher createActivePaymentVoucher(String financialContractUuid,
                                                     BigDecimal voucherAmount, String firstNo,
                                                     String secondType, String bankTransactionNo,
                                                     String receivableAccountNo, String paymentAccountNo,
                                                     String paymentName, String paymentBank,
                                                     SourceDocumentDetailCheckState checkState,
                                                     String cashFlowUuid, Date transactionTime,
                                                     String comment, BigDecimal writrOffAmount) {
        try {
