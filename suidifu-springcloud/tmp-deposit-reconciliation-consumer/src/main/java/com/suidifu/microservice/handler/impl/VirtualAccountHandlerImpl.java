...
public class VirtualAccountHandlerImpl implements VirtualAccountHandler {
    ...
    @Override
    public VirtualAccount refreshVirtualAccountBalance(String ledgerBookNo, String customerUuid,
        String financialContractUuid, String oldVersion) {
        ...
        virtualAccountService.updateBalance(virtualAccountUuid, balance, oldVersion, new Date());
        return virtualAccountService.getVirtualAccountByVirtualAccountUuid(virtualAccountUuid);
    }
