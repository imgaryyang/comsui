...
public class Voucher {
  ...
  /**
   * qinweichao 2017年12月05日 SourceDocumentDetai存文件路径
   */
  ...
  public Voucher(String financialContractUuid, BigDecimal amount, String firstType,
      ...
      String paymentAccountNo, String paymentName, String paymentBank,
  ...
  public static Voucher createActivePaymentVoucher(String financialContractUuid,
    ...
    try {
      ...
      Voucher voucher = new Voucher(financialContractUuid, voucherAmount, voucherSource, firstNo,
          secondType, bankTransactionNo, receivableAccountNo, paymentAccountNo, paymentName,
          paymentBank, checkState, cashFlowUuid, transactionTime, comment, writrOffAmount);
  ...
  public static List<Map<String, Object>> getVoucherStatusList() {
    List<Map<String, Object>> voucherStatusList = EnumUtil
        .getKVList(SourceDocumentDetailStatus.class);
  ...
  public String getVoucherStatusMessage() {
    if (status == SourceDocumentDetailStatus.UNSUCCESS && (
        checkState == SourceDocumentDetailCheckState.UNCHECKED
            || checkState == SourceDocumentDetailCheckState.UNCOMMITTED
            || checkState == SourceDocumentDetailCheckState.CHECK_FAILS)) {
  ...
  public Voucher(String financialContractUuid, String cashFlowUuid, Date transactionTime,
      BigDecimal amount, String firstType,
      String firstNo, String secondType, String secondNo, String receivableAccountNo,
