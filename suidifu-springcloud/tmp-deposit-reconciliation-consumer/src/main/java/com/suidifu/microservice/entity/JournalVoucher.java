...
public class JournalVoucher {
  ...
  @Deprecated
  public JournalVoucher createFromComposentoryVoucher(SourceDocumentDetail sourceDocumentDetail,
      String sourceDocumentNo, AccountSide accountSide, Company company, ContractAccount contractAccount,
  ...
  public JournalVoucher createFromContext(ReconciliationContext context) {
    ...
    resovleJournalVoucherParties(context.getResovler());
  ...
  public void resovleJournalVoucherParties(JournalVoucherResolver resovler) {
  ...
  @Deprecated
  public JournalVoucher createFromActivePaymentVoucher(SourceDocumentDetail sourceDocumentDetail,
      AccountSide accountSide, Company company, VirtualAccount virtualAccount, String sourceDocumentNo) {
    this.sourceDocumentUuid = sourceDocumentDetail.getUuid();
    this.sourceDocumentIdentity = sourceDocumentDetail.getSourceDocumentUuid();
    this.counterAccountType = CounterAccountType.VirtualAccount;
    this.counterPartyAccount = virtualAccount.getVirtualAccountNo();
  ...
  @Deprecated
  public JournalVoucher create_from_auto_recover(VirtualAccount virtualAccount, Company company,
  ...
  @Deprecated
  public JournalVoucher fill_active_payment_voucher_info_after_auto_remittance(
      SourceDocumentDetail sourceDocumentDetail, String sourceDocumentNo) {
    //TODO 余额支付与主动还款凭证的对应。
    this.sourceDocumentUuid = sourceDocumentDetail.getUuid();
    this.sourceDocumentIdentity = sourceDocumentDetail.getSourceDocumentUuid();
    this.counterAccountType = CounterAccountType.VirtualAccount;
