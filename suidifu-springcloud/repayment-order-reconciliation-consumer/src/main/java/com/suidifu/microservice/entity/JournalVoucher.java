...
public class JournalVoucher {
    ...
    public JournalVoucher compensate_active_payment_info_into_existed_auto_remittance(SourceDocumentDetail sourceDocumentDetail, String sourceDocumentNo, JournalVoucherType journalVoucherType, JournalVoucherResolver journalVoucherResovler, SourceDocument sourceDocument) {
        //余额支付与主动还款凭证的对应。
        this.sourceDocumentUuid = sourceDocumentDetail.getUuid();
        this.sourceDocumentIdentity = sourceDocumentDetail.getSourceDocumentUuid();
    ...
    public JournalVoucher compensate_active_payment_info_into_existed_auto_remittance_repayment_order(JournalVoucherType journalVoucherType, JournalVoucherResolver journalVoucherResovler, Date actualRecycleTime, String cashFlowIdentity) {
        //TODO 余额支付与主动还款凭证的对应。
