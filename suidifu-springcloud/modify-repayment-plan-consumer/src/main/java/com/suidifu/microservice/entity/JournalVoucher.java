...
public class JournalVoucher {
    ...
    public JournalVoucher createFromContext(ReconciliationRepaymentContext context) {
        ...
        this.notificationRecordUuid =
            context.getRepaymentOrderItem() == null ? "" : context.getRepaymentOrderItem().getOrderDetailUuid();
        //this.cashFlowTime=context.getRepaymentOrder().getCashFlowTime();
        return this;
    }
    ...
    public void fillBillContractInfo(String relatedBillContractInfoLv1, String relatedBillContractInfoLv2,
        String relatedBillContractInfoLv3, String relatedBillContractNoLv1, String relatedBillContractNoLv2,
        String relatedBillContractNoLv3, String relatedBillContractNoLv4) {
        this.relatedBillContractInfoLv1 = relatedBillContractInfoLv1;
        this.relatedBillContractInfoLv2 = relatedBillContractInfoLv2;
        this.relatedBillContractInfoLv3 = relatedBillContractInfoLv3;
        this.relatedBillContractNoLv1 = relatedBillContractNoLv1;
    ...
    public boolean isCanRefund() {
        return (this.journalVoucherType == JournalVoucherType.VIRTUAL_ACCOUNT_TRANSFER_REPAYMENT
            || this.journalVoucherType == JournalVoucherType.VIRTUAL_ACCOUNT_TRANSFER_GUARANTEE)
            && this.status == JournalVoucherStatus.VOUCHER_ISSUED;
    }
    ...
    public JournalVoucher generateRefundJvFromPaymentJournalVoucher() {
        ...
        BeanUtils.copyProperties(this, journalVoucher, "id", "journalVoucherUuid", "journalVoucherNo", "createdDate",
            "lastModifiedTime", "issuedTime", "counterAccountType",
    ...
    public String getUsedSourceDocumentUuid() {
        Boolean isSourceDocumentIndentity = JournalVoucherMapSpec.sourceDocumentUuidIsSourceDocumentIndentityMap
            .get(getJournalVoucherType());
    ...
    public void fillFlowInformation(BigDecimal cashFlowAmount, String sourceDocumentCashFlowSerialNo,
        CashFlowChannelType cashFlowChannelType, String cashFlowAccountInfo, String bankIdentity) {
