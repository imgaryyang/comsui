...
/**
 * @link com.zufangbao.wellsfargo.silverpool.cashauditing.repayment.handler.ReconciliationRepaymentContext
 */
public class ReconciliationRepaymentContext  
{
	...
	private JournalVoucherResolver resovler;//销账凭证参数解决器
	...
	public JournalVoucherResolver getJournalVoucherResovler() {
		return resovler;
	}
	public void setJournalVoucherResovler(JournalVoucherResolver resovler) {
