...
import com.suidifu.owlman.microservice.spec.JournalVoucherMapSpec;
...
import com.zufangbao.sun.yunxin.enums.voucher.ThirdJournalVoucherType;
...
public class JournalVoucher {
	...
	/*************单据来源*************/
	//一级凭证来源
	private com.zufangbao.sun.yunxin.enums.voucher.JournalVoucherType journalVoucherType;
	//二级凭证来源：例如系统扣款；接口扣款
	...
	private Date getOutlierCapitalTime(ReconciliationContext context){
		if(com.zufangbao.sun.yunxin.enums.voucher.JournalVoucherType.JournalVoucherTypeIsOnline(context.getJournalVoucherType())){
			return null;
		}
	...
	public JournalVoucher compensate_active_payment_info_into_existed_auto_remittance(SourceDocumentDetail sourceDocumentDetail, String sourceDocumentNo, com.zufangbao.sun.yunxin.enums.voucher.JournalVoucherType journalVoucherType, JournalVoucherResovler journalVoucherResovler, SourceDocument sourceDocument){
		//TODO 余额支付与主动还款凭证的对应。
	...
	public JournalVoucher compensate_active_payment_info_into_existed_auto_remittance_repayment_order( com.zufangbao.sun.yunxin.enums.voucher.JournalVoucherType journalVoucherType, JournalVoucherResovler journalVoucherResovler, Date actualRecycleTime, String cashFlowIdentity){
		//TODO 余额支付与主动还款凭证的对应。
	...
	public JournalVoucher fill_voucher_and_booking_amount(String billingPlanUuid, String businessVoucherTypeUuid,
		...
		JournalVoucherCheckingLevel journalVoucherCheckingLevel, com.zufangbao.sun.yunxin.enums.voucher.JournalVoucherType journalVoucherType){
		...
		if(journalVoucherType.equals(com.zufangbao.sun.yunxin.enums.voucher.JournalVoucherType.TRANSFER_BILL_BY_REPURCHASE)){
	...
	public com.zufangbao.sun.yunxin.enums.voucher.SecondJournalVoucherType getSecondJournalVoucherType() {
	...
	public com.zufangbao.sun.yunxin.enums.voucher.ThirdJournalVoucherType getThirdJournalVoucherType() {
		return thirdJournalVoucherType;
	}
	public void setThirdJournalVoucherType(
		com.zufangbao.sun.yunxin.enums.voucher.ThirdJournalVoucherType thirdJournalVoucherType) {
	...
	public void fillVoucherSource(SourceDocument sourceDocument, RepaymentType repaymentType) {
		setJournalVoucherType(com.zufangbao.sun.yunxin.enums.voucher.JournalVoucherType.THIRD_PARTY_DEDUCT_VOUCHER);
	...
	public boolean isCanRefund(){
		return (this.journalVoucherType== com.zufangbao.sun.yunxin.enums.voucher.JournalVoucherType.VIRTUAL_ACCOUNT_TRANSFER_REPAYMENT ||this.journalVoucherType== com.zufangbao.sun.yunxin.enums.voucher.JournalVoucherType.VIRTUAL_ACCOUNT_TRANSFER_GUARANTEE)
			&& this.status == JournalVoucherStatus.VOUCHER_ISSUED;
	}
	...
	public JournalVoucher generateRefundJvFromPaymentJournalVoucher(){
		...
		journalVoucher.setJournalVoucherType(com.zufangbao.sun.yunxin.enums.voucher.JournalVoucherType.VIRTUAL_ACCOUNT_TRANSFER_ROLL_BACK);
