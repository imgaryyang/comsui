...
public interface ThirdPartyVoucherCommandLogService extends GenericService<ThirdPartyVoucherCommandLog> {
	...
	void updateTransactionCommandVoucherLogIssueStatus(
      VoucherLogIssueStatus voucherLogIssueStatus, String voucherNo);

	ThirdPartyVoucherCommandLog getThirdPartyVoucherCommandLogByVoucherUuid(String voucherUuid);
