  ...
  delete from `repayment_plan_extra_data`;
	...
	VALUES ('1', 'cash_flow_uuid_1', '0', '', 'd0503298-e890-425a-44sdf', '600000000001', '云南国际信托有限公司', '10003', 'account_account_no', 'account_account_name', '', '1', '2016-10-13 10:07:13', '1000.00', '6000.00', '', '207e3cd6-7ff0-11e6-a06e-12313', '1万条测试', '', NULL, '', '0.0', '0');
...
('1', NOW(), '1500.00', '1500.00', '500.00', '1000.00', '2016-05-01', '0', 'asset_uuid_1', '2016-05-16 14:26:50', '1', '0', NULL, NULL, '1', '0', 'repayment_plan_no_1', '1',1,0,'financial_contract_uuid_1','0');
...
VALUES
	(10, 'order_uuid_1', 'order_unique_id_1', 'mer_id_1', 'e573be60-f16c-4918-9e8c-b220561b9282',3, 0, 0, 0, 0, 0, 0, 0.00, 6000.00, '2017-06-12 17:40:39', '2017-06-12 17:40:39', '', '127.0.0.1', 'financial_contract_uuid_1', 'G31700', '拍拍贷测试', '/home/dell/Desktop/repaymentOrderDetails/repayment_order_1497260439015062c99f4-ee0c-46ee-af5c-019ed8635eea.csv', 'empty_order_uuid', '', '2016-10-13 10:07:13');

-- repayment way 6为主动付款
INSERT INTO `repayment_order_item` (`id`,`repayment_plan_time`, `order_detail_uuid`, `contract_unique_id`, `contract_no`, `contract_uuid`, `amount`, `detail_alive_status`, `detail_pay_status`, `mer_id`, `financial_contract_uuid`, `repayment_way`, `repayment_business_uuid`, `repayment_business_no`, `repayment_business_type`, `order_uuid`, `order_unique_id`, `remark`)
VALUES
	(1,'1994-11-11 11:11:11', 'order_detail_uuid_1', 'contract_unique_id_1', 'contract_no_1', 'contract_uuid_1', 1500.00, 0, 0, 'mer_id_1', 'financial_contract_uuid_1', 6, 'asset_uuid_1', 'repayment_plan_no_1', 0,  'order_uuid_1', 'oder_unique_id_1', 'remark_1');
