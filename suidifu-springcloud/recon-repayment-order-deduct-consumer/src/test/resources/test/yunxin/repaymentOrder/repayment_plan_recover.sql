...
--	delete from `virtual_account_flow`;
	...
	INSERT INTO `dictionary` (`code`, `content`) VALUES ( 'recievable_loan_carry_over_piority', 'PIORITY_FILLER');
	/*
...
--	('2', 'source_document_detail_uuid_2', 'source_document_uuid_1', 'contract_unique_id_1','repayment_plan_no_1', '100.00', '0', 'BUSINESS_PAYMENT_VOUCHER', 'order_uuid_1', 'enum.voucher-type.pay', 'order_detail_uuid_2', '0');
	...
	INSERT INTO `asset_set` (`id`, `actual_recycle_date`, `asset_fair_value`, `asset_initial_value`, `asset_interest_value`, `asset_principal_value`, `asset_recycle_date`, `asset_status`, `asset_uuid`, `create_time`, `current_period`, `guarantee_status`, `last_modified_time`, `last_valuation_time`, `on_account_status`, `settlement_status`, `single_loan_contract_no`, `contract_id`,`contract_uuid`,`version_no`,`active_status`,`financial_contract_uuid`,`plan_type`) VALUES
	('1', NOW(), '500', '500', '100.00', '400.00', '2016-05-01', '0', 'asset_uuid_1', '2016-05-16 14:26:50', '1', '0', '2016-05-17 14:26:50', NULL, '1', '0', 'repayment_plan_no_1', '1','contract_uuid_1',1,0,'financial_contract_uuid_1','0');
	...
	/*first_repayment_way_group： 还款类型分组：0：线上代扣,1:商户代扣,2:(委托转付,商户代偿，差额划拨，回购)，3:（主动还款，他人贷款）4：表外支付'*/
	...
	VALUES
	(10, 'order_uuid_1', 'order_unique_id_1', 'mer_id_1', 'e573be60-f16c-4918-9e8c-b220561b9282',5, 0, 1, 0, 2, 0, 0, 0.00, 500.00, '2017-06-12 17:40:39', '2017-06-12 17:40:39', '', '127.0.0.1', 'financial_contract_uuid_1', 'G31700', '拍拍贷测试', '/home/dell/Desktop/repaymentOrderDetails/repayment_order_1497260439015062c99f4-ee0c-46ee-af5c-019ed8635eea.csv', 'empty_order_uuid', '');
	
	/*outlier_document_uuid: 外部凭据uuid:如Cashflow.cashFlowUuid*/
	/*outlier_document_identity: 外部凭据唯一标识:如Cashflow.bankSequenceNo*/
	INSERT INTO `payment_order` (`id`, `uuid`,`deduct_request_no`, `request_no`, `order_uuid`, `order_unique_id`, `outlier_document_uuid`, `outlier_document_identity`, `account_side`, `host_account_no`, `host_account_name`, `host_account_bank_name`, `counter_account_no`, `counter_account_name`, `counter_account_bank_name`, `pay_status`, `recover_status`, `pay_way`, `alive_status`, `mer_id`, `financial_contract_uuid`, `financial_contract_no`, `order_pay_result_status`, `amount`, `transaction_time`, `issue_time`, `create_time`, `last_modified_time`, `remark`, `string_field_1`, `string_field_2`, `string_field_3`, `date_field_1`, `date_field_2`, `date_field_3`, `decimal_field_1`, `decimal_field_2`, `decimal_field_3`)
	VALUES 
	('1', 'payment_order_uuid_1','deduct_id_1', NULL, 'order_uuid_1', 'order_unique_id_1', 'deduct_application_uuid_1', NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, '1', '0', '1', NULL, 'mer_id_1', 'financial_contract_uuid_1', NULL, NULL, NULL, NULL, '2017-06-13 17:15:36', '2017-06-06 17:15:34', '2017-06-20 17:15:30', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	...
	VALUES
	(1, 'order_detail_uuid_1', 'contract_unique_id_1', 'contract_no_1', 'contract_uuid_1', 1, 400.00, 0, 0,1, 'mer_id_1', 'financial_contract_uuid_1', 8, 'asset_uuid_1', 'repayment_plan_no_1', 0, '2017-06-15 10:10:10', 'order_uuid_1', 'oder_unique_id_1', 'remark_1');
...
(10, '1e628e99-339c-47d4-b358-ee36ce486484', 0.00, 400.00, 'FST_ACCOUNT_RECEIVED_IN_ADVANCE', '110000', 0, 'SND_ACCOUNT_RECEIVED_IN_ADVANCE_GENERAL', '110000.1000', 'TRD_ACCOUNT_RECEIVED_IN_ADVANCE_GENERAL_PRINCIPAL', '110000.1000.01', 'companyuuid', 'company_customer_uuid_1', NULL, NULL, NULL, 'd936c497-daf7-4ae6-8e57-024b6f0a5fc5', NULL, '2017-08-18 22:38:20', '', NULL, 1, 'contract_uuid_1', NULL, '0c3daa9f-f9d1-4fc2-902e-3678447d8740', 'yunxin_ledger_book', '1', 1, NULL, 1, NULL, NULL, NULL, NULL, ''),
	(11, 'd5dc6a40-b565-4cb7-b77d-cd1b67cf1dcd', 400.00, 0.00, 'FST_BANK_SAVING', '60000', 1, '600000000001', '60000.600000000001', 'TRD_BANK_SAVING_RECEIVABLE_IN_ADVANCE', '60000.1000.18', 'companyuuid', 'company_customer_uuid_1', NULL, NULL, NULL, 'd936c497-daf7-4ae6-8e57-024b6f0a5fc5', NULL, '2017-08-18 22:38:20', '', NULL, 1, 'contract_uuid_1', NULL, '0c3daa9f-f9d1-4fc2-902e-3678447d8740', 'yunxin_ledger_book', '1', 1, NULL, 1, NULL, NULL, NULL, NULL, '');
...
VALUES
	(10, '9a83b842-6606-11e7-aa70-525400dbb013', 'financial_contract_uuid_1', '8', '8aec6aa6-46ac-11e7-881a-b208103af10b');
