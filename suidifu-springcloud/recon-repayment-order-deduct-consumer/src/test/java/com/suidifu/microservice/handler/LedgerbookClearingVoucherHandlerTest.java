...
public class LedgerbookClearingVoucherHandlerTest {
	...
	@Test
	@Sql("classpath:test/yunxin/ledger_book/handlerTest/test_ledger_book_clearing_voucher.sql")
	public void testClearingVoucherWriteOff() {
	    ...
	    List<LedgerItem> itemList =  ledgerItemService.list(LedgerItem.class,new Filter());
