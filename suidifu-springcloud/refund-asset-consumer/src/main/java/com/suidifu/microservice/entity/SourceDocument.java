...
import com.suidifu.microservice.enume.SourceDocumentExcuteResult;
import com.suidifu.microservice.enume.SourceDocumentExcuteStatus;
import com.suidifu.microservice.enume.SourceDocumentType;
import com.suidifu.microservice.model.RemittanceVoucherSpec;
...
public class SourceDocument implements Serializable{
	...
	public static final String FIRSTOUTLIER_TRANSFER = "transfer_cash_flow";
...
//	public static final String SECONDOUTLIER_REPAYMENT_ORDER ="repayment_order";
	 ...
	 */
	private String outlierCounterPartyAccount;//fromAccount

	private String outlierCounterPartyName;
	
	private String outlierAccount;//toAccount
...
//		this.lastModifiedTime(new Date());
	...
	public void initTypePart(String firstOutlierDocType, String secondOutlierDocType, String thirdOutlierDocType,
			...
			SourceDocumentExcuteStatus excuteStatus, SourceDocumentExcuteResult excuteResult, RepaymentAuditStatus auditStatus,String remark){
		this.firstOutlierDocType = firstOutlierDocType;
		this.secondOutlierDocType= secondOutlierDocType;
		this.thirdOutlierDocType = thirdOutlierDocType;
		this.firstAccountId = firstAccountId;
	...
	public String getSourceDocumentDetailStatusName() {
		if (null == sourceDocumentStatus)
			return "";
		for (Map.Entry<SourceDocumentDetailStatus, SourceDocumentStatus> entry : RemittanceVoucherSpec.SourceDocumentStatusConversion
				.entrySet()) {
			if (entry.getValue().equals(sourceDocumentStatus))
				return entry.getKey().getChineseName();
		}
		return "";
	}
}
