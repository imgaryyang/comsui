 ...
 * 
 */
package com.suidifu.barclays.util;
...
public abstract class JsoupUtils {
	...
	public static Result post(String url, String requestBody) throws Exception {
		
		Response response = Jsoup.connect(url).requestBody(requestBody)
...
//	public static String post(String url,String key,Object value) throws Exception{
//		
//		Map<String,Object> data = new HashMap<String,Object>();
//		
//		data.put(key, value);
