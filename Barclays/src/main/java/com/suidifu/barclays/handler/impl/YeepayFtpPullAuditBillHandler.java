 ...
 *         2018/1/10
 */
@Component("yeePayFtpPullAuditHandler")
public class YeepayFtpPullAuditBillHandler extends AuditBillGenericHandler implements AuditBillHandler {
    @Autowired
    private ThirdPartyPayHandler yeePayFtpPullHandler;
    ...
    public List<ThirdPartyAuditBill> execPullThirdPartyAuditBill(Map<String, String> workingParms)
        ...
        try {
            ...
            List<ThirdPartyAuditBillResultModel> auditBillModelList = yeePayFtpPullHandler
                    .pullAuditBill(pullThirdPartyAuditBillModel, workingParms);
