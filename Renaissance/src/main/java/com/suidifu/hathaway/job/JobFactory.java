...
public class JobFactory {
	...
	public static Job createNewJob(String fstBusinessCode, JobType jobType,String jobName,String issuerIdentity,String issuerIP) {
		return createNewJob(fstBusinessCode, StringUtils.EMPTY, StringUtils.EMPTY, jobType, jobName, issuerIdentity, issuerIP);
	}
	public static Job createNewJob(String fstBusinessCode,String secondBusinessCode, JobType jobType,String jobName,String issuerIdentity,String issuerIP) {
		return createNewJob(fstBusinessCode,secondBusinessCode, StringUtils.EMPTY, jobType, jobName, issuerIdentity, issuerIP);
	}
	public static Job createNewJob(String fstBusinessCode,String secondBusinessCode,String thirdBusinessCode, JobType jobType,String jobName,String issuerIdentity,String issuerIP) {
		Job job = new Job(fstBusinessCode, secondBusinessCode,thirdBusinessCode, jobType, jobName, new Date(), null, issuerIdentity, issuerIP);
		return job;
	}
	public static Task createNewTask(String requestUuid,String stageUuid,String jobUuid,String request,String workingQueue, Date expiredTime){
		
		Task task = new Task(requestUuid,stageUuid, jobUuid, request.toString(), null, null, ExecutingStatus.CREATE, new Date(), null, workingQueue, expiredTime);
	...
	public static StageResult createNoDoneStageResult(String jobUuid,String stageUuid, int leftRetryTimes, boolean hasTaskTimeout){
		
		StageResult stageResult = new StageResult(stageUuid, jobUuid, Collections.emptyList(), false, false, leftRetryTimes, hasTaskTimeout);
