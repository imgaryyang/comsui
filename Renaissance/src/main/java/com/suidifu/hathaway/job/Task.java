...
public class Task {
	...
	public Task(String requestUuid,String stageUuid, String jobUUid, String request,
			...
			Date startTime, Date endTime, String workingQueue, Date expiredTime) {
		super();
	...
	public <T> T parseResponse(Type type) {
		
		try{
			
			return JSON.parseObject(this.getResponse(), type);
...
//		this.response = JSON.toJSONString(result) ;
//	}
