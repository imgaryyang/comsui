...
public class DateUtils extends com.demo2do.core.utils.DateUtils {
	...
	public static Date TODAY = DateUtils.parseDate(DateUtils.format(new Date(), DATE_FORMAT), DATE_FORMAT);
	
	public static Date NOW = DateUtils.parseDate(DateUtils.format(new Date(), LONG_DATE_FORMAT), LONG_DATE_FORMAT);
