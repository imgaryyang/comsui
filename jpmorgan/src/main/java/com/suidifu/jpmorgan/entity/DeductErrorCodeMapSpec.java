...
public class DeductErrorCodeMapSpec {
    ...
    public static final Map<String,BusinessErrorReason> ZhongJinErrorCodeAndErrorReasonMap = new HashMap<String,BusinessErrorReason>(){{
        ...
        put("DK20366",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("DK20499",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("1002",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("0002_3008",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("000001",BusinessErrorReason.INSUFFICIENTBALANCE);//
        put("0064",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("3008",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("076502",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("A99",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("004",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("STP1435",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("30",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("100048",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("1024",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("0099",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("PF0178",BusinessErrorReason.INSUFFICIENTBALANCE);
        put("64",BusinessErrorReason.INSUFFICIENTBALANCE);
    }};
    ...
    public static final Map<String,BusinessErrorReason> YEEPAYErrorCodeAndErrorReasonMap = new HashMap<String,BusinessErrorReason>(){{
        put("TZ2010027",BusinessErrorReason.INSUFFICIENTBALANCE);//余额不足
    }};

    public static final Map<String, BusinessErrorReason> LdysErrorCodeAndErrorReasonMap = new HashMap<String, BusinessErrorReason>() {{
        put("00080537", BusinessErrorReason.INSUFFICIENTBALANCE);//余额不足
    ...
    public static final Map<String,Map<String,BusinessErrorReason>> PaymentGatewayAndErrorCodeMap = new HashMap<String,Map<String,BusinessErrorReason>>(){{
        put(PaymentHandlerFactory.GATEWAY_TYPE_UNIONPAY_GZ,GZUionErrorCodeAndErrorReasonMap);
        put(PaymentHandlerFactory.GATEWAY_TYPE_ElECPAY_BAOFU,BaoFuErrorCodeAndErrorReasonMap);
        put(PaymentHandlerFactory.GATEWAY_TYPE_ElECPAY_CPCN,ZhongJinErrorCodeAndErrorReasonMap);
        put(PaymentHandlerFactory.GATEWAY_TYEP_YEEPAY,YEEPAYErrorCodeAndErrorReasonMap);
        put(PaymentHandlerFactory.GATEWAY_TYPE_ElECPAY_LDYS, LdysErrorCodeAndErrorReasonMap);
        put(PaymentHandlerFactory.GATEWAY_TYPE_EPAY, EPayErrorCodeAndErrorReasonMap);
    }};


    public static BusinessErrorReason getBusinessErrorReason(String PaymentGateway,String errorCode){
