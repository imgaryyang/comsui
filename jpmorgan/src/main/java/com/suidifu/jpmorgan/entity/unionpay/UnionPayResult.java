...
public class UnionPayResult {
	...
	public UnionPayResult(String code) {
		this.code = code;
	}
	
	public UnionPayResult success() {
		this.code = SUCCESS;
		return this;
	}
	
	public UnionPayResult fail() {
		this.code = FAIL;
		return this;
	}
	
	public UnionPayResult message(String message) {
		this.message = message;
		return this;
	}
	
	public UnionPayResult data(String key, Object value) {
	...
	public String toString() {
		return "UnionPayResult [code=" + code + ", message=" + message
