...
public class TransactionResultQueryApiConstant {
	...
	public static class ErrMsg{
		...
		public static final String ERR_MSG_END_DATE_BEGIN_DATE_GT_3 = "起始日期与结束日期跨度超过3天";
		...
		public static final String ERR_Account = "该账号尚未开放打款服务";
	}
