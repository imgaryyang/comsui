...
@Component("TestPaymentGateWaySuperBankHandler")
public class TestPaymentGateWaySuperBankHandler implements PaymentHandler{
	...
	private static Log logger = LogFactory.getLog(TestPaymentGateWaySuperBankHandler.class);
