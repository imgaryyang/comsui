 ...
 */
@Component("cmbcDirectBankPaymentHandler")
public class CmbcDirectBankPaymentHandlerImpl implements PaymentHandler {
    @Autowired
    ...
    public CreditResult executeSinglePay(PaymentOrder paymentOrder, WorkingContext context) {
        ...
        return cmbcDirectBankHandler.singleCredit(creditModel, workParams);
    }
    ...
    public QueryCreditResult executeQueryPaymentStatus(PaymentOrder paymentOrder, WorkingContext context) {
        ...
        return cmbcDirectBankHandler.queryCredit(queryCreditModel, workParams);
    }
