...
VALUES
  (2, 'xiaoyu', '70991db75ebb24fa0993f4fa25775022', b'0', 'http://beta.demo2do.com/jupiter/', '寓见', 5, NULL, NULL,
   NULL);
...
INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`, `user_upload_param`, `unique_particle_id`, `transfer_status`, `modify_time`, `unique_bill_id`, `contract_payment_amount`, `contract_payment_type`, `doubt_record`, `virtual_account_unique_id`, `collection_bill_capital_status`, `asset_package_id`)
VALUES
  (1, '2015-12-07', NULL, NULL, 'C33-20150928-9', 2, NULL, NULL, b'0', NULL, '22000.00', 1, 1, 0, NULL, NULL, 0, NULL,
                                                                                         'yuanlai_C33-20150928-9_6774',
                                                                                         '22000.00', 1, NULL, NULL, 3,
   13),
  (2, '2016-01-07', NULL, NULL, 'C33-20150928-10', 2, NULL, NULL, b'0', NULL, '22000.00', 1, 1, 0, NULL, NULL, 0, NULL,
                                                                                          'yuanlai_C33-20150928-10_6775',
                                                                                          '22000.00', 1, NULL, NULL, 3,
   13),
  (3, '2016-02-07', NULL, NULL, 'C33-20150928-11-repo', 2, NULL, NULL, b'0', NULL, '22000.00', 1, 1, 0, NULL, NULL, 0,
                                                                                               NULL,
                                                                                               'yuanlai_C33-20150928-11_6776',
                                                                                               '22000.00', 1, NULL,
   NULL, 3, 13),
  (4, '2016-03-07', NULL, NULL, 'C33-20150928-12', 2, NULL, NULL, b'0', NULL, '22000.00', 1, 1, 0, NULL, NULL, 0, NULL,
...
VALUES
  ...
  (2, '00000452059224352', 2, '2015-09-21 17:04:26', NULL, 'C33-20150928-10', '16500.00', NULL, NULL, 2, 2, 3),
  (3, '00000452059224353', 2, '2015-09-21 17:05:26', NULL, 'C33-20150928-11-repo', '17000.00', NULL, NULL, 2, 2, 3),
