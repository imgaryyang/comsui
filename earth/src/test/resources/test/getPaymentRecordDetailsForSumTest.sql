...
INSERT INTO `customer` (`id`, `account`, `city`, `mobile`, `name`, `province`, `source`, `app_id`) VALUES
  (1035, NULL, NULL, NULL, '全玥', NULL, '寓见', 1),
  (1113, NULL, NULL, NULL, '袁特立', NULL, '寓见', 1),
  (1114, NULL, NULL, NULL, '胡杰兆', NULL, '寓见', 1),
  (1115, NULL, NULL, NULL, '刘晓旭', NULL, '寓见', 1);

INSERT INTO `escrow_contract` (`id`, `arrival_days`, `single_service_fee`, `app_id`, `escrow_agreement_id`) VALUES
  (2, NULL, NULL, 9, 2),
  (3, NULL, NULL, 4, 3),
  (4, NULL, NULL, 8, 4),
  (5, NULL, NULL, 1, 5);

INSERT INTO `escrow_agreement` (`id`, `escrow_account_id`, `repayment_account_id`) VALUES
  (2, 11, 10),
  (3, 11, 8),
  (4, 11, 12),
  (5, 7, 20);

INSERT INTO `batch_pay_record` (`id`, `amount`, `apply_time`, `creator_id`, `modify_time`, `operator_id`, `pay_status`, `pay_time`, `remark`, `request_no`, `serial_no`, `payer_account_id`, `payment_institution_id`, `receive_account_id`, `confirm_time`)
VALUES
  (1, '43250.00', '2015-06-24 15:25:00', 9, '2015-06-24 15:30:49', 1, 1, '2015-06-24 15:30:49', '23套房源风险准备金0624PM',
      NULL, '20150624110070101500000002423900', 7, 2, 6, NULL),
  (2, '26800.00', '2015-06-26 16:30:00', 1, '2015-06-26 16:32:33', 1, 1, '2015-06-26 16:32:33', '16套房源风险准备金0626PM',
      NULL, '1548062644620819003', 7, 2, 6, NULL),
  (3, '18150.00', '2015-07-03 11:10:15', 8, '2015-07-03 14:10:39', 1, 1, '2015-07-03 14:10:39', '11套房源风险准备金0703AM ',
      NULL, '1554070327971079005', 7, 2, 6, NULL);
...
VALUES
  ...
  (3, 'test4Zufangbao', '2e85ae999845f25faf8ea7b514ee0aca', b'0', 'http://e.zufangbao.cn', '租房宝测试账号', 3, NULL, NULL,
   NULL);
...
VALUES
  (1, '2015-09-01', 'HQWB8#701-2015-09-08', 0, '10000.00', '2016-08-31', NULL, '', '10000.00', b'0', 3, NULL, NULL, 1,
   971, 913, 0),
...
VALUES
  (555, '2015-09-29 00:00:00', 00000001, NULL, NULL, '2015-09-29 10:30:10', '2015-09-29 00:00:00', 184800.00, 184800.00,
        264000.00, NULL, 975, 66);
...
VALUES
  (4,
   '[{\"accountName\":\"上海源涞实业有限公司\",\"accountNo\":\"121913751710201\",\"alias\":\"源涞国际回款户\",\"bank\":{\"areaCode\":\"21\",\"bankType\":\"TraditionalBank\",\"branchNo\":\"21\",\"cityCode\":\"SHSH\",\"code\":\"CMB\",\"deleted\":false,\"fullName\":\"招商银行上海天钥桥支行\",\"id\":11,\"shortName\":\"招商银行\"},\"bankAccount\":true,\"id\":18}]',
   17, 16, 16, 15, '44bcf65b-c138-48f4-afd5-929bbdd979ee');


INSERT INTO `batch_pay_detail` (`id`, `create_time`, `creator_id`, `pay_money`, `pay_time`, `batch_pay_record_id`, `order_id`)
VALUES
...
VALUES
  (1, '2016-08-07', NULL, NULL, 'C33-20150928-17', 0, NULL, NULL, b'0', NULL, '22000.00', 1, 1035, 0, NULL, NULL, 0,
                                                                                          NULL,
                                                                                          'yuanlai_C33-20150928-17_6782',
                                                                                          '22000.00', 1, NULL, NULL),
  (2, '2016-09-07', NULL, NULL, 'C33-20150928-18', 0, NULL, NULL, b'0', NULL, '22000.00', 2, 1035, 0, NULL, NULL, 0,
                                                                                          NULL,
                                                                                          'yuanlai_C33-20150928-18_6783',
                                                                                          '22000.00', 1, NULL, NULL);

INSERT INTO `transaction_record_log` (`id`, `modified_time`, `operator_id`, `transaction_record_operate_status`, `transaction_record_id`)
VALUES
  (5, '2015-04-13 19:27:02', 130, 1, 25),
...
VALUES
  (23, NULL, 1, '2015-09-10 16:15:26', '641804989666624512', 'C33-20150928-17', '3900.00',
       '20150910104649641804989666624512', '2015091000001000850066807154', 2, 1, 2),
  (24, NULL, 1, '2015-09-10 12:22:58', '641829168600253440', 'C33-20150928-18', '1200.00',
       '20150910122253641829168600253440', NULL, 2, 1, 2),
  (25, NULL, 1, '2015-09-10 16:15:43', '641804989666624512', 'C33-20150928-17', '3900.00',
       '20150910104649641804989666624512', '2015091000001000850066807154', 2, 1, 2);
