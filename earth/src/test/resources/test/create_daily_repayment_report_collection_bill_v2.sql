...
VALUES
  (627, '2016-02-24', '2016-03-23', NULL, 'KXHY1#1803#ORDER#1', 0, 0.00, NULL, b'0', '2016-02-24', 9500.00, 1, 1, 0,
                                                                                                            NULL,
                                                                                                            'unique_particle_id-12cdaa660e05',
                                                                                                            1, NULL,
                                                                                                            'unique_bill_id-11_627',
                                                                                                            9500.00, 1,
    NULL, 'virtual_account-04824b9daa1a', 1, 1, 4, 13, 1, 0, 58, 'audit_bill_id-359614b4c721', 2, 0,
   'repayment_bill-fb74e18e0830');
...
INSERT INTO `business_voucher` (`id`, `account_id`, `account_side`, `billing_plan_breif`, `billing_plan_type_uuid`, `billing_plan_uuid`, `business_voucher_status`, `business_voucher_type_uuid`, `business_voucher_uuid`, `company_id`, `receivable_amount`, `settlement_amount`, `tax_invoice_uuid`)
VALUES
  (3024, 0, 1, '', 'AUDIT_BILL_BILLING_PLAN', 'audit_bill_id-359614b4c721', 2, 'AUDIT_BILL_BUSINESS_VOUCHER',
         'business_voucher-359614b4c721', 4, 9500.00, 9500.00, NULL);
...
VALUES
  (6371, 1, '', 'unique_bill_id-11_627', 9500.00, 'AUDIT_BILL_BILLING_PLAN', 'business_voucher-359614b4c721', 9500.00,
         '', 0, '0', '558fc1f8-b05c-440e-a246-8dcfc1375b98', 1, 1, 1, NULL, NULL,
                     'ecd50a7e-abf4-40e6-873b-dd51b8256254', '2016-02-29-15.35.00.477789', '房租', NULL, NULL, NULL, NULL,
                                                                                                       NULL, NULL, NULL,
                                                                                                       NULL, NULL, 1,
                                                                                                       '2016-02-29 15:35:00',
   NULL, '2016-03-01 13:23:09');
...
VALUES
  (1, '52500.00', 2, '6222081001006853570', '1001300219000027827', '永业公寓28号604', '2015-03-30-22.39.56.930280',
      '2015-03-30 22:39:56', 2, '2', '徐月', '网转', '0', NULL);
