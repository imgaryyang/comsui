...
INSERT INTO `payment_agreement` (`id`, `hosting_account`, `repayment_account_id`, `risk_reserve_account_id`, `zfb_account_id`)
VALUES
  ('1', '3', '1', '2', '5');
...
VALUES ('xiaoyu', b'0', '2015-04-27 15:00:58', '963eb1401db6fc3cfce2a7cd5e9f916d');
...
INSERT INTO `principal` (`id`, `authority`, `name`, `password`) VALUES
  ...
  (4, 'ROLE_APP', 'yopark', 2, 'e10adc3949ba59abbe56e057f20f883e');

INSERT INTO `contract_partical`
(`channel_assgin`, `contract_id`, `modified_time`, `partical_unique_id`, `is_delete`)
VALUES (0, 48, '2015-04-30 14:00:00', '963eb1401db6fc3cfce2a7cd5e9f916d', b'0'),
