...
INSERT INTO `asset_set` (`id`, `guarantee_status`, `settlement_status`, `asset_fair_value`, `asset_principal_value`, `asset_interest_value`, 
                         ...
                         `single_loan_contract_no`, `contract_id`, `actual_recycle_date`, `current_period`,`version_no`,`active_status`,
                         `executing_status`,`plan_type`)
                   VALUES 
                        -- asset为冻结还款单
						('323', '1', '0', '1217.40', '0.00', '1200.00', 
						 ...
						 'ZC27367D23EF4A36F4', '323', NULL, '1',1,2,
						 0,0),
						-- asset2为已作废的asset
						('324', '1', '0', '1220.00', '0.00', '1200.00',
						 '1200.00', '2016-05-17', NULL, '0.00', '0', '1',
						 0, '2016-06-15 22:13:45', 'asset_set_uuid_2', '2016-06-15 22:04:59', '2016-06-15 23:24:31', NULL, 
						 'single_loan_contract_no_2', '323', NULL, '1',2,1,
						 0,0),
						 -- asset3为提前还款单
						('325', '1', '0', '1220.00', '0.00', '1200.00',
                         '1200.00', '2016-05-17', NULL, '0.00', '0', '1', 
                         0, '2016-06-15 22:13:45', 'asset_set_uuid_3', '2016-06-15 22:04:59', '2016-06-15 23:24:31', NULL, 
                         'single_loan_contract_no_3', '323', NULL, '1',3,2,
                         0,1);
