...
(1, 'customer_account_1', NULL, 'company_customer_1', NULL, 1,'company_customer_uuid_1',1),
(2, 'customer_account_2', NULL, 'customer_2', NULL, 1,'customer_uuid_2',0);
...
(1, 'contract_uuid_1','contract_unique_id_1','2015-10-19', 'DKHD-001', '2016-10-19', 1, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 1000, 0.0001,1,'financial_contract_uuid_1','customer_uuid_2');

INSERT INTO `repurchase_doc` (`id`, `repurchase_doc_uuid`, `financial_contract_uuid`, `amount`,`repurchase_principal`, `repurchase_interest`,`repurchase_penalty`,`repurchase_other_charges`, `repo_start_date`, `repo_end_date`, `repo_days`, `creat_time`, `verification_time`, `last_modifed_time`, `contract_id`, `contract_no`, `app_id`, `app_name`, `customer_uuid`, `customer_name`, `executing_asset_set_uuids`, `asset_set_uuids`, `repurchase_status`) VALUES
('1', 'repayment_plan_no_1', 'financial_contract_uuid_1', '500.00','500',0,0,0 , '2016-10-20', '2016-11-03', '3', '2016-10-31 20:14:59', NULL, '2016-10-31 20:14:59', '1', 'DKHD-001', '1', '安美途', 'company_customer_uuid_1', NULL, NULL, '["asset_uuid_1"]', '0');
...
('1', 'source_document_detail_uuid_1', 'source_document_uuid_1', 'contract_unique_id_1','repayment_plan_no_1', '500.00', '0', 'enum.voucher-source.business-payment-voucher', 'bank_transaction_no_1', 'enum.voucher-type.repurchase', 'cash_flow_no_1', '0','2');
