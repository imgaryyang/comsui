...
log.info("start delay task");
        ...
        workParams.put("paidPrincipal", AmountUtil.transToAmount(detailAmount.getLoanAssetPrincipal())+"");
        workParams.put("paidInterest", AmountUtil.transToAmount(detailAmount.getLoanAssetInterest())+"");
        workParams.put("paidRepayCharge", AmountUtil.transToAmount(detailAmount.get_total_fee_except_principal_interest())+"");
