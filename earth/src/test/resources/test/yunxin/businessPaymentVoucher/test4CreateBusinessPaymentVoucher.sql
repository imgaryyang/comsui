...
INSERT INTO `financial_contract` (`adva_repayment_term`,`id`,`ledger_book_no`,`adva_matuterm`, `contract_no`, `app_id`, `company_id`,`adva_repo_term`,`capital_account_id`,`payment_channel_id`,`financial_contract_uuid`) VALUES 
...
('3db60870add840668fba06718e4c3ddd', '工商银行', '上海拍拍贷金融信息服务有限公司', '1001133419006708197', 1, 1, '016cce27-f37f-4d68-a0a1-23beb6966141', 0, null, null, null, null, null, null);
...
(0, 0, 1010.00, 500.00, 500.00, 1000.00, '2015-10-19', null, null, 0, null, 0, null, 'asset_uuid_1', '2015-10-19 13:34:35', '2015-10-19 13:34:35', null, 'DKHD-001-01', 1, '2015-10-19 13:34:35', 0, 0, null, null, 0, 0, 'empty_deduct_uuid', null, null, null, null, null, null, 0, 0, 0, 0, 0, 0, null, null, '007127e8-28c2-11e7-bfdc-795b5bba90a4', null);

INSERT INTO `contract` (`id`,`unique_id`, `begin_date`, `contract_no`,`end_date`,`app_id`, `customer_id`, `house_id`,`actual_end_date`, `create_time`, `interest_rate`, `payment_day_in_month`, `payment_frequency`, `periods`, `repayment_way`, `total_amount`, `penalty_interest`,`financial_contract_uuid`) VALUES
(1,'unique_id_01', '2015-10-19', 'DKHD-001', '2016-10-19', 1, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 1000, 0.0001,'x12323ww');
...
-- ('007127e8-28c2-11e7-bfdc-795b5bba90a4', 'unique_id_001', '2015-10-19', 'DKHD-001', '2016-10-19', null, null, 1, 1, 1, null, '2015-10-19 13:34:35', 0.0010000000, 1, 1, 12, 0, 1000.00, 0.0001000000, null, null, 2, 'x12323ww', 0, null);
...
-- VALUES
-- ('1', 'batch_pay_record_uuid_1', '0', NULL, NULL, '11014807398006', '杭州随地付网络技术有限公司', '1001133419006708197', '上海拍拍贷金融信息服务有限公司', NULL, '{\"bankCode\":\"\",\"bankName\":\"中国民生银行\"}', '0', '2016-08-16 15:21:26', '0.10', '22.81', NULL, '1122049', '0816 平安银企直连测试', '实时转账', NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

INSERT INTO cash_flow (cash_flow_uuid, cash_flow_channel_type, company_uuid, host_account_uuid, host_account_no, host_account_name, counter_account_no, counter_account_name, counter_account_appendix, counter_bank_info, account_side, transaction_time, transaction_amount, balance, transaction_voucher_no, bank_sequence_no, remark, other_remark, strike_balance_status, trade_uuid, issued_amount, audit_status, date_field_one, date_field_two, date_field_three, long_field_one, long_field_two, long_field_three, string_field_one, string_field_two, string_field_three, decimal_field_one, decimal_field_two, decimal_field_three) VALUES
('batch_pay_record_uuid_1', 0, null, null, '11014807398006', '杭州随地付网络技术有限公司', '1001133419006708197', '上海拍拍贷金融信息服务有限公司', null, '{"bankCode":"","bankName":"中国民生银行"}', 0, '2016-08-16 15:21:26', 0.10, 100.00, null, '1122049', '0816 平安银企直连测试', '实时转账', null, null, null, 0, null, null, null, null, null, null, null, null, null, null, null, null);
...
-- ('2','uuid_1112','source_document_uuid_2','contract_unique_id','plan_no2','500.00','2','fist_type','first_no', '11', 'serial_no_2', NULL,'5615156s','16151551','李四','农业银行','0','comment'),
-- ('3','uuid_1113','source_document_uuid_2','contract_unique_id','plan_no3','500.00','1','fist_type','first_no', '11', 'serial_no_2', NULL,'5615156s','16151551','王二','招商银行','0','comment'),
-- ('4','uuid_1114','source_document_uuid_3','contract_unique_id','plan_no4','500.00',NULL,'fist_type','first_no', '11', 'serial_no_4', NULL,'5615156s','16151551','周五','招商银行','0','comment'),
-- ('5','uuid_1115','source_document_uuid_3','contract_unique_id','plan_no5','500.00',NULL,'fist_type','first_no', '11', 'serial_no_5', NULL,'5615156s','16151551','周五','招商银行','0','comment');
