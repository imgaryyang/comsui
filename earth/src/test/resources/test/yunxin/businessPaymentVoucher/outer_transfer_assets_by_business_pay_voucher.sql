...
INSERT INTO `financial_contract` (`id`,`financial_contract_uuid`, `adva_matuterm`, `contract_no`, `contract_name`, `app_id`, `company_id`,   `adva_repo_term`,`loan_overdue_end_day`,`loan_overdue_start_day`,`payment_channel_id`,`ledger_book_no`,`asset_package_format`,`financial_contract_type`) VALUES 
('1', 'financial_contract_uuid_1', 3, 'DCF-NFQ-LR903A', '云南信托', 1, 1, 30,90,1,1,'yunxin_ledger_book',1,0);
...
(1, 'contract_uuid_1','contract_unique_id_1','financial_contract_uuid_1','2015-10-19', 'DKHD-001', '2016-10-19', 1, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 1000, 0.0001,1),
...
('1', '10005.00', '9126313e-f89d-4222-847c-4e36331cb787', '7d3aad51-05f1-4896-abff-caee93afca79','company_customer_uuid_1', '', '2016-08-24 21:27:10', '2016-08-27 16:57:09');
...
('1', 'source_document_detail_uuid_1', 'source_document_uuid_1', 'contract_unique_id_2','repayment_plan_no_1', '1000.00', '0', 'BUSINESS_PAYMENT_VOUCHER', 'bank_transaction_no_1', 'enum.voucher-type.pay', 'cash_flow_no_1', '0',2),
('2', 'source_document_detail_uuid_2', 'source_document_uuid_2', 'contract_unique_id_2','repayment_plan_no_2', '500.00', '0', 'BUSINESS_PAYMENT_VOUCHER', 'bank_transaction_no_1', 'enum.voucher-type.pay', 'cash_flow_no_2', '0',2);
