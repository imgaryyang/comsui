...
('1','1', 'source_document_uuid_1', '1', '2016-08-24 18:58:23', '0', '1', '2700.00', 'cash_flow_uuid_1', '2016-08-24 16:56:18', 'account_account_no', 'account_account_name', 'yunxin_account_no', '1', 'cash_flow_no_1', NULL, '2000', '3', '测试', '1', NULL, 'FST_LIABILITIES_OF_INDEPENDENT_ACCOUNTS', 'SND_LIABILITIES_INDEPENDENT_CUSTOMER_DEPOSIT', '', NULL, '0', 'compay_customerUuid2', '1', '9126313e-f89d-4222-847c-4e36331cb787', '50000', '50000.01',0 , 0, 'financial_contract_uuid_1','source_document_no');



INSERT INTO `source_document_detail` (`principal`,`interest`,`penalty_fee`,`other_charge`,`id`, `uuid`, `source_document_uuid`, `contract_unique_id`, `repayment_plan_no`, `amount`, `status`, `first_type`, `first_no`, `second_type`, `second_no`, `payer`,`check_state`) VALUES 
('2100.00','100.00','200.00','300.00','1', 'source_document_detail_uuid_1', 'source_document_uuid_1', 'contract_unique_id_1','repayment_plan_no_1', '2700.00', '0', 'enum.voucher-source.business-payment-voucher', 'bank_transaction_no_1', 'enum.voucher-type.repurchase', 'cash_flow_no_1', '0','0');
