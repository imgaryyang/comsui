...
('1', 'cash_flow_uuid_1', '0', '', 'd0503298-e890-425a-4444444', '600000000001', '云南国际信托有限公司', '10001', '测试7', '', '', '1', '2016-10-28 20:00:17', '400.00', '655.00', '', 'fd046df0-91f7-11e6-b4d9-98eecb339690', '郑航波1.23', '', NULL, '', '900.00', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `financial_contract` (`adva_repayment_term`,`id`,`financial_contract_uuid`, `adva_matuterm`, `contract_no`, `contract_name`, `app_id`, `company_id`,   `adva_repo_term`,`loan_overdue_end_day`,`loan_overdue_start_day`,`payment_channel_id`,`ledger_book_no`,`asset_package_format`,`financial_contract_type`,`repayment_check_days`) VALUES 
('0','1', 'financial_contract_uuid_1', 3, 'DCF-NFQ-LR903A', '云南信托', 1, 1, 30,90,1,1,'yunxin_ledger_book',1,0,7);
...
('1', '10005', '9126313e-f89d-4222-847c-4e36331cb787', '7d3aad51-05f1-4896-abff-caee93afca79','company_customer_uuid_1', '', '2016-08-24 21:27:10', '2016-08-27 16:57:09','testaccount');
...
INSERT INTO `asset_set` (`id`, `actual_recycle_date`, `asset_fair_value`, `asset_initial_value`, `asset_interest_value`, `asset_principal_value`, `asset_recycle_date`, `asset_status`, `asset_uuid`, `create_time`, `current_period`, `guarantee_status`, `last_modified_time`, `last_valuation_time`, `on_account_status`, `settlement_status`, `single_loan_contract_no`, `contract_id`,`version_no`,`active_status`,`financial_contract_uuid`,`plan_type`,`order_payment_status`) VALUES 
('1', NULL, '1000.00', '1000.00', '100.00', '900.00', '2016-05-01', '0', 'asset_uuid_1', '2016-05-16 14:26:50', '1', '0', NULL, NULL, '1', '0', 'repayment_plan_no_1', '7',1,0,'financial_contract_uuid_1','0','1'),
('2', NULL, '500.00', '500.00', '200.00', '800.00', '2016-05-05', '0', 'asset_uuid_2', '2016-05-16 14:26:50', '2', '0', NULL, NULL, '1', '0', 'repayment_plan_no_2', '7',1,0,'financial_contract_uuid_1','0','0');
...
('1','1', 'source_document_uuid_1', '1', '2016-08-24 18:58:23', '0', '1', '1500.00', 'cash_flow_uuid_1', '2016-10-30 20:00:17', 'account_account_no', 'account_account_name', 'yunxin_account_no', '1', 'cash_flow_no_1', NULL, '2000', '3', '测试', '1', NULL, 'FST_LIABILITIES_OF_INDEPENDENT_ACCOUNTS', 'SND_LIABILITIES_INDEPENDENT_CUSTOMER_DEPOSIT', '', NULL, '0', 'compay_customerUuid2', '1', 'cfa28906-adb0-4b81-a6c2-d84fe4033947', '50000', '50000.01',0 , 0, 'financial_contract_uuid_1','source_document_no');
...
INSERT INTO `source_document_detail` (`id`, `uuid`, `source_document_uuid`, `contract_unique_id`, `repayment_plan_no`, `amount`, `status`, `first_type`, `first_no`, `second_type`, `second_no`, `payer`,`actual_payment_time`,`check_state`) VALUES 
('1', 'source_document_detail_uuid_1', 'source_document_uuid_1', 'contract_unique_id_2','repayment_plan_no_1', '1000.00', '0', 'enum.voucher-source.business-payment-voucher', 'bank_transaction_no_1', 'enum.voucher-type.pay', 'cash_flow_no_1', '0','2016-10-29 14:26:50','0'),
('2', 'source_document_detail_uuid_2', 'source_document_uuid_1', 'contract_unique_id_2','repayment_plan_no_2', '500.00', '0', 'enum.voucher-source.business-payment-voucher', 'bank_transaction_no_1', 'enum.voucher-type.pay', 'cash_flow_no_1', '0','2016-10-29 14:26:50','0');
