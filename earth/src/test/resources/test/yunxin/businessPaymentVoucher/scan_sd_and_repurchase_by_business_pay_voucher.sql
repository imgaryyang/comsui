...
('1', 'yunxin_ledger_book', '1', '1', '','dasdsad');
...
(1, 'contract_uuid_1','contract_unique_id_1','2015-10-19', 'DKHD-001', '2016-10-19', 1, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 1000, 0.0001,1,'financial_contract_uuid_1');
...
('1', 'repayment_plan_no_1', 'financial_contract_uuid_1', '500.00', '2016-10-20', '2016-11-03', '3', '2016-10-31 20:14:59', NULL, '2016-10-31 20:14:59', '1', 'DKHD-001', '1', '安美途', 'company_customer_uuid_1', NULL, NULL, '["asset_uuid_1"]', '0');
...
INSERT INTO `source_document_detail` (`id`, `uuid`, `source_document_uuid`, `voucher_uuid`,`contract_unique_id`, `repayment_plan_no`, `amount`, `status`, `first_type`, `first_no`, `second_type`, `second_no`, `payer`,`check_state`) VALUES
('1', 'source_document_detail_uuid_1', 'source_document_uuid_1', 'voucher_uuid_1','contract_unique_id_1','repayment_plan_no_1', '500.00', '0', 'enum.voucher-source.business-payment-voucher', 'bank_transaction_no_1', 'enum.voucher-type.repurchase', 'cash_flow_no_1', '0','0');
