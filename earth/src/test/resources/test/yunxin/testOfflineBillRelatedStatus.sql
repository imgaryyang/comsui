...
INSERT INTO `offline_bill` (`financial_contract_uuid`,`id`, `amount`, `bank_show_name`, `comment`, `create_time`, `is_delete`, `last_modified_time`, `offline_bill_no`, `offline_bill_status`, `offline_bill_uuid`, `serial_no`, `payer_account_name`, `payer_account_no`)
VALUES 
('ae07d211-2c10-43ed-9924-3d7988db6fe4','1', '1000.00', '中国银行', '备注', '2016-04-01 14:22:58', '\0', '2016-04-01 14:23:27', 'BC00001', '1', 'uuid', 'serial_no', 'payer_account_name', 'account_no');
