...
INSERT INTO `financial_contract` (`id`, `adva_matuterm`, `contract_no`, `app_id`, `company_id`, `adva_repo_term`,`payment_channel_id`,`financial_contract_uuid`,`ledger_book_no`,`adva_repayment_term`)
VALUES
	(2, 3, 'YX-AMT-1', 1, 1, 0.0850000000,1,'financial_contract_uuid_1','ledger_book_no',1);
...
INSERT INTO `rent_order` (`id`, `order_type`, `due_date`, `order_no`, `total_rent`, `customer_id`, `user_upload_param`, `modify_time`, `repayment_bill_id`, `asset_set_id`, `create_time`, `clearing_status`, `executing_settling_status`,`financial_contract_id`)
VALUES
	(1, 0, NOW(), 'JS272F890AC51F8E71', 29831.56, 1, '[1]', '2016-05-04 17:15:24', '854f7d819114434d8a019f7fe7964a14', 1, '2016-05-04 15:17:01', 0, 0,2);

INSERT INTO `asset_set` (`id`, `guarantee_status`, `settlement_status`, `asset_fair_value`, `asset_principal_value`, `asset_initial_value`, `asset_recycle_date`, `asset_status`, `on_account_status`, `repayment_plan_type`, `last_valuation_time`, `asset_uuid`, `create_time`, `last_modified_time`, `single_loan_contract_no`, `contract_id`, `actual_recycle_date`, `current_period`,`version_no`,`financial_contract_uuid`)
VALUES
	(1, 0, 0, 29831.56, 14831.56, 29831.56, '2016-05-05', 0, 1, 0, '2016-05-04 15:17:00', 'asset_uuid_1', '2016-05-04 15:13:01', '2016-05-04 17:15:24', 'ZC272F8904AC73B66F1', 1, '2016-05-04 17:15:24', 1,1,'financial_contract_uuid_1');
