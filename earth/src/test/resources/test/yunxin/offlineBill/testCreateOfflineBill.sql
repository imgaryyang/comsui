...
INSERT INTO `asset_set` (`id`, `guarantee_status`, `asset_fair_value`,`asset_initial_value`, `asset_recycle_date`, `asset_status`, `on_account_status`, `repayment_plan_type`, `last_valuation_time`, `asset_uuid`, `create_time`, `last_modified_time`, `single_loan_contract_no`, `contract_id`, `actual_recycle_date`, `current_period`, `version_no`)
VALUES
	(1, 0, 1000,1000, '2015-10-19', 0, 1, 0, '2016-04-07 21:49:04', '0d712307-a747-4a57-9fa5-792cf76c1a4c', '2016-04-06 16:43:47', '2016-04-07 21:49:04', 'test-contract-1-1', 1, NULL, 1,1),
	(2, 0, 1000,1000, '2015-10-19', 0, 1, 0, NULL, '1676780d-15bf-4fe3-968c-62be2b02c3aa', '2016-04-06 16:43:47', NULL, 'test-contract-1-2', 1, NULL, 2,1),
	(3, 2, 1000,1000, '2015-10-19', 1, 1, 0, '2016-04-07 21:49:04', '25804e12-b6ad-4ca4-86d5-6e6cb7616847', '2016-04-06 16:43:47', '2016-04-07 21:49:04', 'test-contract-2-1', 2, '2015-10-19', 1,1);
...
INSERT INTO `customer` (`id`, `account`, `app_id`) VALUES 
('1', '01091081XXXXX', '1'),
('2', '01091082XXXXX', '1');

INSERT INTO `financial_contract` (`id`, `adva_matuterm`, `contract_no`, `app_id`, `company_id`,   `adva_repo_term`,`adva_repayment_term`) VALUES 
...
-- id为4的单子为 结算单； id为1,2,3的是差额补足单;id为3的差额补足单所对应的资产为已补足
