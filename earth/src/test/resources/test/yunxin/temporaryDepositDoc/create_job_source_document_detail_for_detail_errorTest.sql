...
VALUES
	(1, 'detail_uuid_1', 'source_document_uuid_1', 'contract_unique_id_1', 'repayment_plan_no_1', 450.00, 0, 'enum.voucher-source.business-payment-voucher', 'temporary_deposit_doc_1', 'enum.voucher-type.pay', 'random_uuid', 0, '600000000001', '1001133419006708197', '上海拍拍贷金融信息服务有限公司', 'bank', 0, NULL, 'financial_contract_uuid_1','380','70.00','0.00','0.00','voucher_uuid_1');
