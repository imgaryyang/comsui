...
Map<String, Object> data = (Map<String, Object>) processedResult.getData();
            ...
            SandboxDataSet sandboxDataSet = sandboxDataSetHandler.get_sandbox_by_repaymentPlanNoList(financialContractUuid, contractUuid, repaymentPlanNoTarList);
            ...
            log.info("start to get paymentPlanSnapshotList data");
            ...
            for (PaymentPlanSnapshot paymentPlanSnapshot: paymentPlanSnapshotList) {
                ...
                if(sandboxDataSet.getFinancialContractSnapshot().getContractNo() == "HA0100"){
