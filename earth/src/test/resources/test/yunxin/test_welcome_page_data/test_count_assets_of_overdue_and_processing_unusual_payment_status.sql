...
INSERT INTO `asset_set` (`id`, `asset_fair_value`,`asset_initial_value`, `asset_recycle_date`, `asset_status`, `asset_uuid`, `create_time`, `last_modified_time`, `single_loan_contract_no`, `financial_contract_uuid`,`contract_id`, `actual_recycle_date`,`version_no`,`active_status`,`guarantee_status`,`overdue_status`) VALUES 
('1', 1010,1000, NOW(), 0, 'asset_uuid_1', '2015-10-19 13:34:35', '2015-10-19 13:34:35', 'DKHD-001-01', 'uuid1',1, NULL,1,0,0,2),
('2', 1000,1000, DATE_ADD(NOW(),INTERVAL -2 DAY), 0, 'asset_uuid_2', '2015-10-20 13:34:35', '2015-10-20 13:34:35', 'DKHD-001-02','uuid1', 1, NULL,1,0,0,2),
('3', 1000,1000, DATE_ADD(NOW(),INTERVAL -3 DAY), 0, 'asset_uuid_3', '2015-10-20 13:34:35', '2015-10-20 13:34:35', 'DKHD-002-01', 'uuid2',2, NULL,1,0,0,2),
('4', 1000,1000, DATE_ADD(NOW(),INTERVAL -4 DAY), 0, 'asset_uuid_4', '2015-10-20 13:34:35', '2015-10-20 13:34:35', 'DKHD-002-02', 'uuid2',2, NULL,1,0,0,0);
