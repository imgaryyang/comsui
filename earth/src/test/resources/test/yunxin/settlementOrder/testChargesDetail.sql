...
INSERT INTO `rent_order` (`id`, `due_date`, `order_no`, `payout_time`, `total_rent`, `customer_id`, `user_upload_param`, `modify_time`, `asset_set_id`, `create_time`,`clearing_status`,`executing_settling_status`,`financial_contract_id`,`charges_detail`) VALUES
(1, '2016-10-09', 'DKHD-001-01-20160307', '2016-10-19 13:34:35',1000, '1','', '2016-01-19', 1, '2015-10-19', 0,0,1,'{\"loanAssetInterest\":1.11,\"loanAssetPrincipal\":2.22,\"loanOtherFee\":0,\"loanServiceFee\":0,\"loanTechFee\":0,\"overdueFeeObligation\":0,\"overdueFeeOther\":0,\"overdueFeePenalty\":0,\"overdueFeeService\":0}');
