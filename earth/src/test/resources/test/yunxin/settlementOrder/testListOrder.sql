...
INSERT INTO `financial_contract` (`adva_repayment_term`,`id`, `adva_matuterm`, `contract_no`, `app_id`, `company_id`,   `adva_repo_term`, `payment_channel_id`) VALUES 
('0','1', 3, 'YX_AMT_001', 1, 1, 30,1),
('0','2', 3, 'YX_AMT_002', 2, 1, 30,1);
...
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`,`end_date`,`app_id`, `customer_id`, `house_id`,`actual_end_date`, `create_time`, `interest_rate`, `payment_day_in_month`, `payment_frequency`, `periods`, `repayment_way`, `total_amount`, `penalty_interest`,`month_fee`,`active_version_no`,`asset_type`) VALUES 
(1, '2015-10-19', 'DKHD-001', '2016-10-19', 1, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 10000, 0.0001,1000,1,1),
(2, '2015-10-20', 'DKHD-002', '2016-10-19', 2, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 10000, 0.0001,1000,1,1);


INSERT INTO `rent_order` (`id`, `due_date`, `order_no`,`asset_set_uuid`, `payout_time`, `total_rent`, `customer_id`, `user_upload_param`, `modify_time`, `asset_set_id`, `create_time`,`clearing_status`,`executing_settling_status`,`financial_contract_id`) VALUES
(1, '2016-10-09', 'DKHD-001-01-20160307','asset_uuid_1', '2016-10-19 13:34:35',1000, '1','', '2016-01-19', 1, '2015-10-11 00:01:03', 0,0,1),
(2, '2016-10-11', 'DKHD-001-01-20160308', 'asset_uuid_1','2016-10-19 13:34:35',1000, '1','', '2016-02-19', 1, '2015-10-11 23:01:03',0,1,1),
(3, '2016-10-09', 'DKHD-001-02-20160409', 'asset_uuid_2','2016-10-19 13:34:35',1000, '1','', '2016-03-19', 2, '2015-10-19 23:01:03',0,1,1),
(4, '2016-10-11', 'DKHD-001-02-20160410','asset_uuid_2', '2016-10-19 13:34:35',1000, '1','', '2016-04-19', 2, '2015-10-19 23:01:03',1,2,1),
(5, '2016-11-09', 'DKHD-002-01-20160411', 'asset_uuid_3','2016-10-19 13:34:35',1000, '1','', '2016-05-19', 3, '2015-10-19 23:01:03',1,2,2),
(6, '2016-11-12', 'DKHD-002-02-20160412', 'asset_uuid_4','2016-10-19 13:34:35',1000, '1','', '2016-06-19', 4, '2015-10-19 23:01:03',0,3,2);
