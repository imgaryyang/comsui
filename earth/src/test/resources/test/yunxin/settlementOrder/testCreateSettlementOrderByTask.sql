...
INSERT INTO `financial_contract` (`id`, `adva_matuterm`, `contract_no`, `app_id`, `company_id`,   `adva_repo_term`,`ledger_book_no`,`sys_create_penalty_flag`,`financial_contract_uuid`,`sys_create_statement_flag`,`adva_repayment_term`) VALUES 
('1', 3, 'YX_AMT_001', 1, 1, 30,'ledger_book_no',1,'uuid',1,1);
...
INSERT INTO `rent_order` (`id`, `due_date`, `order_no`, `payout_time`, `total_rent`, `customer_id`, `user_upload_param`, `modify_time`, `asset_set_id`, `asset_set_uuid`,`create_time`, `clearing_status`, `executing_settling_status`) VALUES
(1, '2016-01-19', 'DKHD-001-01-20160307', '2016-10-19 13:34:35',1000, '1','', '2016-10-19', 1, 'asset_uuid_1','2015-10-19',0,3),
(2, '2016-01-20', 'DKHD-001-01-20160308', '2016-10-19 13:34:35',1000, '1','', '2016-10-19', 1,'asset_uuid_1', '2015-10-19',0,1),
(3, Date(NOW()), 'DKHD-001-02-20160409', '2016-10-19 13:34:35',1000, '1','', '2016-10-19', 2,'asset_uuid_2', Date(NOW()),0,0),
(4, Date(NOW()), 'DKHD-001-04-20160409', '2016-10-19 13:34:35',1000, '1','', '2016-10-19', 4, 'asset_uuid_4','2015-10-19',0,0);
