...
INSERT INTO `asset_set` (`id`, `guarantee_status`, `asset_fair_value`,`asset_initial_value`, `asset_recycle_date`, `asset_status`, `on_account_status`, `repayment_plan_type`, `last_valuation_time`, `asset_uuid`, `create_time`, `last_modified_time`, `single_loan_contract_no`, `contract_id`, `actual_recycle_date`, `current_period`,`version_no`,`active_status`,`financial_contract_uuid`)
VALUES
	(1, 2, 2984.65, 2984.65, DATE_ADD(NOW(),INTERVAL -1 DAY), 1, 1, 0, '2016-04-07 21:49:04', '0d712307-a747-4a57-9fa5-792cf76c1a4c', '2016-04-06 16:43:47', '2016-04-07 21:49:04', 'test-contract-1-1', 1, NOW(), 1,1,0,'financial_contract_uuid_1');

INSERT INTO `financial_contract` (`id`, `adva_matuterm`, `contract_no`, `app_id`, `company_id`, `adva_repo_term`,`financial_contract_uuid`,adva_repayment_term) VALUES 
('1', 3, 'YX_AMT_001', 1, 1, 30,'financial_contract_uuid_1',1);
