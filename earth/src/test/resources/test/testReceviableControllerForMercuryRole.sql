...
VALUES
  ...
  (2, 'yopark', '123456', 00000000, '', '优帕克', 4);
...
INSERT INTO `rent_order` (
  ...
  `contract_id`,
  `customer_id`) VALUES
  ('96', '2015-04-12', NULL, NULL, 'YPK-CZ-0001-13', 0, '16.00', NULL, '', NULL, '16.00', '48', '62'),
...
INSERT INTO `principal` (`id`, `authority`, `name`, `password`) VALUES
  ...
  (5, 'ROLE_APP', 'test4QuarkNoParticle', 2, 'e10adc3949ba59abbe56e057f20f883e');
