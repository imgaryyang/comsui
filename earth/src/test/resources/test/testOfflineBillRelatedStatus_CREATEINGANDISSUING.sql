...
VALUES
  ('1', '1000.00', '中国银行', '备注', '2016-04-01 14:22:58', '[\"D001\"]', '\0', '2016-04-01 14:23:27', 'BC00001', '1',
        'uuid', '[\"DKHD-001-01-20160307\",\"DKHD-001-01-20160308\",\"DKHD-001-01-20160309\"]', 'serial_no',
   'payer_account_name', 'account_no', '[\"test-contract-1-1\",\"test-contract-1-2\",\"test-contract-2-1\"]'),
  ('2', '1000.00', '中国银行', '备注', '2016-04-01 14:22:58', '[\"D001\"]', '\0', '2016-04-01 14:23:27', 'BC0000112312', '1',
        'uuid12423', '[\"DKHD-001-01-20160307\",\"DKHD-001-01-20160308\",\"DKHD-001-01-20160309\"]', 'serial_no',
   'payer_account_name', 'account_no', '[\"test-contract-1-1\",\"test-contract-1-2\",\"test-contract-2-1\"]');
...
VALUES
  ('1', '2', 'uuid', '1', '2016-04-21 17:19:23', '2016-04-15 17:19:26', '0', NULL, '0.00', 'uuid', NULL, NULL, NULL,
                                                                                                         NULL, NULL,
                                                                                                         NULL, NULL,
                                                                                                         NULL, NULL,
                                                                                                         NULL, NULL,
   NULL, NULL, NULL, 'offline_bill', NULL, NULL, NULL, '1');
('2', '2', 'uuid', '1', '2016-04-21 17:19:23', '2016-04-15 17:19:26', '0', NULL, '0.00', 'uuid12423', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'offline_bill', NULL, NULL, NULL, '2');
