...
VALUES
  (3696, NULL, NULL, NULL, 'test20150728-11', 0, 0.00, NULL, 00000000, NULL, 100.00, 490, 550, NULL, NULL, NULL, 0,
   NULL, 'test4Zufangbao_test20150728-11_3696');
...
VALUES
  (3, 'test4Zufangbao', '2e85ae999845f25faf8ea7b514ee0aca', 00000000, 'http://e.zufangbao.cn', '租房宝测试账号', 9, NULL, NULL,
   NULL);
