...
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`, `contract_status`, `end_date`, `month_fee`, `payment_instrument`, `url`, `customer_id`, `house_id`, `app_id`, `non_deposit_guarantee_way`)
VALUES
  (3, '2015-02-02', '10120212', 0, '2015-09-02', 3000.00, 1, NULL, 4, 3, 1, b'0');


INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`)
VALUES
