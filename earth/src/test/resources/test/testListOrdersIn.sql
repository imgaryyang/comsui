...
INSERT INTO `rent_order` (
  ...
  ('829', '2015-04-12', NULL, NULL, 'YPK-CZ-0001-12', 0, NULL, NULL, '', NULL, '16.00', '48', '62', '0',
   '5a9155df-4e63-44cb-870b-e548858f0d69'),
  ('2961', '2015-04-13', NULL, NULL, 'YPK-CZ-0001-10', 0, NULL, NULL, '', NULL, '16.00', '48', '62', '1',
   'c2ac9722-9eed-4d9f-8062-65b8803b0664'),
  ('2962', '2015-04-12', NULL, NULL, 'YPK-CZ-0001-11', 0, NULL, NULL, '', NULL, '16.00', '48', '62', '1',
   'c2ac9722-9eed-4d9f-8062-65b8803b0664');
...
VALUES
  (256, '2015-04-13', '2015-05-12', NULL, 'CC-60445-3', 2, 0.10, NULL, 00000000, '2015-04-13', 0.10, 64, 125, 0, NULL,
                                                                                                     '9dfca839-5d8e-419d-8e9c-50fad3683b9e',
                                                                                                     0, NULL,
                                                                                                     'testForXiaoyu_CC-60445-3_256',
                                                                                                     NULL, NULL, NULL,
                                                                                                                 '3f16b3e8-98ac-47ae-89a7-61de75f61967',
                                                                                                                 3, 3,
                                                                                                                 3, -1,
                                                                                                                 0, 0,
                                                                                                                 -1,
...
VALUES
  (32021, '5a9155df-4e63-44cb-870b-e548858f0d69', 00000000, '2015-07-10 00:00:00', '953fb78f2d6f6ea9cb10a82d399e4464',
   1, 359, 2948),
...
INSERT INTO `order_virtual_account_relation` (`id`, `account_unique_id`, `is_delete`, `modified_time`, `partical_unique_id`, `transfer_status`, `contract_id`, `order_id`)
VALUES
  (33011, 'c2ac9722-9eed-4d9f-8062-65b8803b0664', 00000000, '2015-08-10 19:06:22',
   '09b1cfbb-09d8-4440-85b2-67840fb59a77', 1, 126, 828);

INSERT INTO `order_virtual_account_relation` (`id`, `account_unique_id`, `is_delete`, `modified_time`, `partical_unique_id`, `transfer_status`, `contract_id`, `order_id`)
VALUES
  (33012, 'c2ac9722-9eed-4d9f-8062-65b8803b0664', 00000000, '2015-08-10 19:06:22',
   '09b1cfbb-09d8-4440-85b2-67840fb59a77', 1, 126, 829);
