...
INSERT INTO `app_arrive_record` (`id`, `amount`, `arrive_record_status`, `pay_ac_no`, `receive_ac_no`, `remark`, `serial_no`, `time`, `app_id`, `drcrf`, `pay_name`, `summary`, `vouh_no`)
VALUES ('4', '52500.00', '2', '6222081001006853570', '1001300219000027827', '永业公寓28号604', '2015-03-30-22.39.56.930280',
             '2015-03-30 22:39:56', '2', '2', '徐月', '网转', '0');

INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`)
VALUES
  (352, '2015-8-7', '2015-9-6', NULL, 'YXXH1#2307-20150414-5', 2, '1500', NULL, '\0', '2015-8-7', 14500.00, 76, 137, 0);
INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`)
VALUES
  (508, '2015-9-7', '2016-10-6', NULL, 'YXXH1#2307-20150414-6', 1, '1600', NULL, '\0', '2015-9-7', 14500.00, 93, 137,
   0);
INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`)
VALUES
  (741, '2015-11-30', '2015-12-29', NULL, 'YCHT7#1201-20150508-12', 2, '1700', NULL, '\0', '2015-11-30', 16400.00, 13,
   177, 0);
INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`)
VALUES
  (742, '2015-11-30', '2015-12-29', NULL, 'YCHT7#1201-20150508-13', 0, '1800', NULL, '\0', '2015-11-30', 16400.00, 177,
   177, 0);
INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`)
VALUES
  (2919, '2015-06-29', '2015-12-29', NULL, 'order-paid-1', 0, NULL, NULL, '\0', '2015-11-30', 16400.00, 91, 412, 0);
INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`)
VALUES
  (509, '2015-9-7', '2016-10-6', NULL, 'YXXH1#2307-20150414-7', 0, '1600', NULL, '\0', '2015-9-7', 14500.00, 94, 137,
   0);
INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`)
VALUES
  (510, '2015-7-21', '2016-10-6', NULL, 'YXXH1#2307-20150414-8', 0, '1600', NULL, '\0', '2015-9-7', 14500.00, 95, 107,
   0);
INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`)
VALUES
...
INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`)
VALUES
  (495, '2015-9-7', '2016-10-6', NULL, 'YCHT7#1201-20150508-15', 0, '1600', NULL, '\0', '2015-9-7', 14500.00, 96, 177,
   0);
INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`)
VALUES
  (496, '2015-9-7', '2016-10-6', NULL, 'YCHT7#1201-20150508-16', 0, '1600', NULL, '\0', '2015-9-7', 14500.00, 96, 177,
   0);
INSERT INTO `rent_order` (`id`, `due_date`, `end_date`, `late_fee`, `order_no`, `order_status`, `paid_rent`, `payout_time`, `is_settled`, `start_date`, `total_rent`, `contract_id`, `customer_id`, `repayment_type`)
VALUES
  (497, '2015-9-7', '2016-10-6', NULL, 'YCHT7#1201-20150508-17', 0, '1600', NULL, '\0', '2015-9-7', 14500.00, 96, 177,
   0);
...
VALUES ('1', '16500.00', '1', '2015-04-03 12:00:00', '\0', '2015-04-03 12:00:00', '4', '742', '0');
INSERT INTO `receive_order_map` (`id`, `amount`, `association_type`, `create_time`, `is_deducted`, `pay_time`, `app_arrive_record_id`, `order_id`, `receive_order_map_status`)
VALUES ('2', '16500.00', '1', '2015-04-03 12:00:00', '\0', '2015-04-03 12:00:00', '21', '153', '0');
INSERT INTO `receive_order_map` (`id`, `amount`, `association_type`, `create_time`, `is_deducted`, `pay_time`, `app_arrive_record_id`, `order_id`, `receive_order_map_status`)
VALUES ('3', '13500.00', '1', '2015-04-03 12:00:00', '', '2015-04-03 12:00:00', '19', '134', '0');
INSERT INTO `receive_order_map` (`id`, `amount`, `association_type`, `create_time`, `is_deducted`, `pay_time`, `app_arrive_record_id`, `order_id`, `receive_order_map_status`)
VALUES ('4', '12600.00', '1', '2015-04-03 12:00:00', '', '2015-04-03 12:00:00', '23', '119', '0');
...
VALUES
  ('13', '2015-04-01', 'KXHY1#1803', '0', '33000.00', '2016-03-31', NULL, '', '16500.00', '\0', '0', NULL, NULL, '2',
   '106', '13');
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`, `contract_status`, `deposit`, `end_date`, `interrupt_date`, `interrupt_reason`, `month_fee`, `non_deposit_guarantee_way`, `payment_instrument`, `renewal`, `url`, `app_id`, `customer_id`, `house_id`)
VALUES
  ('93', '2014-11-01', 'HNHY3#602', '0', '25200.00', '2015-10-31', NULL, '', '12600.00', '\0', '0', NULL, NULL, '2',
   '107', '14');
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`, `contract_status`, `deposit`, `end_date`, `interrupt_date`, `interrupt_reason`, `month_fee`, `non_deposit_guarantee_way`, `payment_instrument`, `renewal`, `url`, `app_id`, `customer_id`, `house_id`)
VALUES
  ('15', '2014-06-01', 'HQHY1#33B', '0', '34000.00', '2015-11-30', NULL, '', '17000.00', '\0', '0', NULL, NULL, '2',
   '108', '15');
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`, `contract_status`, `deposit`, `end_date`, `interrupt_date`, `interrupt_reason`, `month_fee`, `non_deposit_guarantee_way`, `payment_instrument`, `renewal`, `url`, `app_id`, `customer_id`, `house_id`)
VALUES ('16', '2014-05-01', 'JAGJ1804', '0', '27000.00', '2016-04-30', NULL, '', '13500.00', '\0', '0', NULL, NULL, '2',
        '109', '16');
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`, `contract_status`, `deposit`, `end_date`, `interrupt_date`, `interrupt_reason`, `month_fee`, `non_deposit_guarantee_way`, `payment_instrument`, `renewal`, `url`, `app_id`, `customer_id`, `house_id`)
VALUES ('91', '2014-05-01', 'TEST-ZFB', '0', '27000.00', '2016-04-30', NULL, '', '13500.00', '\0', '0', NULL, NULL, '3',
        '110', '17');
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`, `contract_status`, `deposit`, `end_date`, `interrupt_date`, `interrupt_reason`, `month_fee`, `non_deposit_guarantee_way`, `payment_instrument`, `renewal`, `url`, `app_id`, `customer_id`, `house_id`)
VALUES
  ('94', '2014-11-01', 'HNHY3#6002', '0', '25200.00', '2015-10-31', NULL, '', '12600.00', '\0', '0', NULL, NULL, '3',
   '111', '18');
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`, `contract_status`, `deposit`, `end_date`, `interrupt_date`, `interrupt_reason`, `month_fee`, `non_deposit_guarantee_way`, `payment_instrument`, `renewal`, `url`, `app_id`, `customer_id`, `house_id`)
VALUES
  ('95', '2014-11-01', 'HNHY3#60002', '0', '25200.00', '2015-10-31', NULL, '', '12600.00', '\0', '0', NULL, NULL, '4',
   '112', '19');
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`, `contract_status`, `deposit`, `end_date`, `interrupt_date`, `interrupt_reason`, `month_fee`, `non_deposit_guarantee_way`, `payment_instrument`, `renewal`, `url`, `app_id`, `customer_id`, `house_id`)
VALUES
...
VALUES ('412', NULL, NULL, '13732255076', '上海化耀国际贸易有限公司', NULL, '优帕克', '4');
INSERT INTO `customer` (`id`, `account`, `city`, `mobile`, `name`, `province`, `source`, `app_id`)
...
VALUES ('23', NULL, '1', '2015-04-13 23:31:14', '587589379743482880', 'CC-60446-2', '0.01',
              '20150413081554587589379743482880', '2015041300001000450050496693', '2', '1', '2');
INSERT INTO `transaction_record` (`id`, `card_no`, `channel`, `last_modified_time`, `merchant_payment_no`, `order_no`, `pay_money`, `request_no`, `trade_no`, `transaction_record_status`, `app_id`, `payment_institution_id`)
VALUES ('24', NULL, '1', '2015-04-13 20:19:45', '587590022008865792', 'CC-60446-2', '0.01',
              '20150413081826587590022008865792', '2015041300001000330052443978', '1', '1', '2');
INSERT INTO `transaction_record` (`id`, `card_no`, `channel`, `last_modified_time`, `merchant_payment_no`, `order_no`, `pay_money`, `request_no`, `trade_no`, `transaction_record_status`, `app_id`, `payment_institution_id`)
VALUES ('25', NULL, '1', '2015-04-13 20:24:44', '587591431290815488', 'CC-60446-2', '0.01',
              '20150413082402587591431290815488', '2015041300001000330052444444', '1', '1', '2');
INSERT INTO `transaction_record` (`id`, `card_no`, `channel`, `last_modified_time`, `merchant_payment_no`, `order_no`, `pay_money`, `request_no`, `trade_no`, `transaction_record_status`, `app_id`, `payment_institution_id`)
VALUES ('26', NULL, '1', '2015-04-13 20:29:31', '587592712440972288', 'CC-60446-2', '0.01',
              '20150413082908587592712440972288', '2015041300001000450050497773', '1', '1', '2');
INSERT INTO `transaction_record` (`id`, `card_no`, `channel`, `last_modified_time`, `merchant_payment_no`, `order_no`, `pay_money`, `request_no`, `trade_no`, `transaction_record_status`, `app_id`, `payment_institution_id`)
VALUES ('27', NULL, '1', '2015-04-13 20:33:02', '587592810998727680', 'CC-60446-2', '0.01',
              '20150413082931587592810998727680', '2015041300001000330052445086', '1', '1', '2');
INSERT INTO `transaction_record` (`id`, `card_no`, `channel`, `last_modified_time`, `merchant_payment_no`, `order_no`, `pay_money`, `request_no`, `trade_no`, `transaction_record_status`, `app_id`, `payment_institution_id`)
VALUES ('28', NULL, '1', '2015-04-13 20:36:11', '587594235258536960', 'CC-60446-2', '0.01',
              '20150413083511587594235258536960', '2015041300001000450050498312', '1', '1', '2');
INSERT INTO `transaction_record` (`id`, `card_no`, `channel`, `last_modified_time`, `merchant_payment_no`, `order_no`, `pay_money`, `request_no`, `trade_no`, `transaction_record_status`, `app_id`, `payment_institution_id`)
VALUES ('29', NULL, '1', '2015-04-13 20:53:52', '587598844224013312', 'CC-60446-2', '0.01',
              '20150413085329587598844224013312', '2015041300001000450050500061', '1', '1', '2');

INSERT INTO `app_sms_config` (`id`, `is_deleted`, `sms_rule_suit`, `app_id`, `is_need_link`, `default_sms_rule`)
VALUES
  (8, 00000000,
   '[{\"contentTemplate\":\"(##appName##)您当期房租##amount##元已到支付日期，请及时完成支付！请点击链接[##link##]【随地付】\",\"ruleScript\":\"function execute(order){return (order.getDistanceFromTodayToDueDay() == 0);}\",\"ruleUniqueId\":\"c99c94d7-74d9-4f68-a845-d1f7e7ea48f6\"}]',
   4, 00000001,
   '{\"contentTemplate\":\"(##appName##)您当期房租##amount##元已到支付日期，请及时完成支付！请点击链接[##link##]【随地付】\",\"ruleScript\":\"function execute(order){return true;}\",\"ruleUniqueId\":\"936c9600-d26f-45fa-b42e-cab4fd492497\"}');
