...
INSERT INTO `app` (`id`, `app_id`, `app_secret`, `is_disabled`, `host`, `name`, `company_id`) VALUES
  (1, 'xiaoyu', '123456', 00000000, 'http://beta.demo2do.com/jupiter/', '寓见', 2),
  (2, 'youpark', '123456', 00000000, '', '优帕克', 2);
...
-- 接入商家的个性化显示信息
INSERT INTO `app_account` (`id`, `channel`, `header`, `logo`, `name`, `app_id`, `account_name`, `account_no`) VALUES
  (1, 1, NULL, NULL, '小寓科技', 1, NULL, NULL),
  (2, 2, NULL, 1, '优帕克', 2, '上海优帕克投资管理有限公司', '1001300219000027827');
...
INSERT INTO `contract` (`id`, `begin_date`, `contract_no`, `contract_status`, `deposit`, `end_date`, `interrupt_date`, `interrupt_reason`,
                        `month_fee`, `non_deposit_guarantee_way`, `payment_instrument`, `renewal`, `url`, `customer_id`, `house_id`, `app_id`)
VALUES
  ...
  ('50', '2014-07-01', 'YPK-CZ-0003', '0', '20000.00', '2015-12-31', NULL, '', '10.00', b'0', '0', NULL, NULL, '64',
   '53', '2'),
  ('51', '2014-07-01', 'YPK-CZ-0004', '0', '20000.00', '2015-12-31', NULL, '', '10.00', b'0', '0', NULL, NULL, '64',
   '53', '2');
...
-- 金融公司表
INSERT INTO `company` (`id`, `bank_name`, `card_no`, `name`) VALUES
  (2, '平安银行', '333444555', '鼎程（上海）商业保理有限公司');
...
INSERT INTO `factoring_contract` (
  ...
  `company_id`)          -- 对接金融公司
VALUES
  ('54', '7', '0.70', '2015-04-01 00:00:00', '180', '98.00', '0.00', '0.00', '0.00', '30', '1', '98.00', '优帕克',
                                                                                                'DCF-YPK-0001', '2',
                                                                                                '0', '2', '0.198', NULL,
                                                                                                '工商银行', '100001', '鼎程',
...
VALUES
  (1, 'http://localhost:9999/quark/', '银联', 0, 0, '963eb1401db6fc3cfce2a7cd5e9f916d'),
...
VALUES
  (1, '/bill-deposite/revoke', 'revokeBills', '963eb1401db6fc3cfce2a7cd5e9f916d'),
  (2, '/bill-deposite/app-config/sync', 'syncAppConfig', '963eb1401db6fc3cfce2a7cd5e9f916d'),
  (3, '/bill-deposite/assgin', 'assignBills', '963eb1401db6fc3cfce2a7cd5e9f916d'),
  ...
  (7, '/bill-deposite/hot-snapshot/all', 'snapShotHotBills', '963eb1401db6fc3cfce2a7cd5e9f916d'),
  (8, '/bill-deposite/cooling-bills', 'coolingHotBills', '963eb1401db6fc3cfce2a7cd5e9f916d'),
  (9, '/bill-deposite/transactions/from-bills', 'getTrasactionRecords', '963eb1401db6fc3cfce2a7cd5e9f916d'),
  (10, '/bill-deposite/transactions/confirm', 'confirmTrasactionRecords', '963eb1401db6fc3cfce2a7cd5e9f916d');

INSERT INTO `app_particles` (`app_id`, `is_delete`, `modified_time`, `unique_partical_id`)
VALUES ('youpark', b'0', '2015-04-27 15:00:58', '963eb1401db6fc3cfce2a7cd5e9f916d');
...
VALUES (2, 48, '2015-04-30 14:00:00', '963eb1401db6fc3cfce2a7cd5e9f916d', b'0'),
  (0, 49, '2015-04-30 14:00:00', '963eb1401db6fc3cfce2a7cd5e9f916d', b'0'),
