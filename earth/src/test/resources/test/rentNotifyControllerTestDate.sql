...
INSERT INTO `contract` (`id`, `contract_no`, `contract_status`, `payment_instrument`, `app_id`, `customer_id`, `house_id`, `contract_type`, `non_deposit_guarantee_way`)
VALUES
...
VALUES
  (1, '2015-8-7', '2015-9-6', NULL, 'YXXH1#2307-20150414-5', 2, '1500', NULL, '\0', '2015-8-7', 14500.00, 1, 1, 0,
...
VALUES
  (13, '2015-04-01', 'test-meijia-20150710', 0, 33000.00, '2016-03-31', NULL, '', 16500.00, 00000000, 1, NULL, NULL, 9,
   106, 13, 0, 1, 0);
...
VALUES
  ('2015-04-01', 'test-meijia-20150710', 0, 33000.00, '2016-03-31', NULL, '', 16500.00, 00000000, 1, NULL, NULL, 9, 107,
   13, 0, 1, 0),
...
INSERT INTO `sms_log` (`id`, `app_id`, `send_result`, `send_time`, `sms_content`, `sms_log_type`, `mobile`) VALUES
  ...
  ('32', 'testForZhuKe', '-1', '2015-07-28 12:00:01', '(驻客测试)您当期房租10.00元已到支付日期，请及时完成支付！请点击链接[http://t.cn/RLKTkhV]【随地付】',
   '1', NULL),
  ('33', 'woju', '0', '2015-07-28 12:00:02', '(杭州蜗居2)您当期房租0.10元已到支付日期，请及时完成支付！请点击链接[http://t.cn/RLKWMia]【随地付】', '1',
   NULL),
  ('34', 'woju', '0', '2015-07-28 20:35:11', '(杭州蜗居2)您当期房租0.03元已到支付日期，请及时完成支付！请点击链接[http://t.cn/RLonJEz]【随地付】', '0',
   NULL),
  ('35', 'woju', '0', '2015-07-28 20:40:58', '(杭州蜗居2)您当期房租0.05元已到支付日期，请及时完成支付！请点击链接[http://t.cn/RLonJyh]【随地付】', '0',
   NULL),
  ('36', 'woju', '0', '2015-07-29 12:00:02',
   '(杭州蜗居2)提醒您：您当期房租账单金额12.00元，支付日期2015-07-30，请及时支付！请点击链接[http://t.cn/RL9gtz9]【随地付】', '1', NULL),
  ('37', 'woju', '0', '2015-07-29 12:00:02',
   '(杭州蜗居2)提醒您：您当期房租账单金额12.00元，支付日期2015-07-30，请及时支付！请点击链接[http://t.cn/RL9gtZg]【随地付】', '1', NULL),
  ('38', 'woju', '0', '2015-07-29 14:07:11', '(杭州蜗居2)您当期房租12.00元已到支付日期，请及时完成支付！请点击链接[http://t.cn/RL9gtZg]【随地付】', '0',
   '13732255076');
