...
public class RepaymentOrderOverdueRepayDelayTaskServices implements DelayTaskServices{
    @Override
    public boolean evaluate(Result processedResult, DelayProcessingTaskCacheHandler delayProcessingTaskHandler, SandboxDataSetHandler sandboxDataSetHandler, Map<String, Object> inputMap, Map<String, Object> resultMap, Log log) {
        ...
        workParams.put("repayFine", AmountUtil.transToAmount(detailAmount.getOverdueFeePenalty())+"");//逾期罚息
        ...
        workParams.put("repayTotalAmount", AmountUtil.transToAmount(detailAmount.getTotalFee())+"");
        workParams.put("repayDateTime", tradeTime==null?"":com.zufangbao.sun.utils.DateUtils.format(tradeTime, com.zufangbao.sun.utils.DateUtils.LONG_DATE_FORMAT));
