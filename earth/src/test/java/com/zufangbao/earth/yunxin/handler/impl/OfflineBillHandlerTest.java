...
public class OfflineBillHandlerTest extends AbstractTransactionalJUnit4SpringContextTests{
	...
	public void testConnectionOrderOfAll() {
		try {
			...
			AssetSet assetSet = repaymentPlanService.getUniqueRepaymentPlanByUuid(orderAfter.getAssetSetUuid());
