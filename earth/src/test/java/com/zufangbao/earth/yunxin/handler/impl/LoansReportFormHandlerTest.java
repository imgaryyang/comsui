...
public class LoansReportFormHandlerTest extends AbstractTransactionalJUnit4SpringContextTests{
	@Autowired 
	...
	public void test_query_null(){
		LoansQueryModel queryModel = null;
//		List<LoansShowModel> list = handler.query(queryModel, );
//		Assert.assertEquals(0, list.size());
		List<LoansShowModel> list = handler.query(queryModel, null);
		Assert.assertEquals(0, list.size());
	}
