...
public class YunxinOfflinePaymentControllerTest extends
	...
	public void testOfflineBillList() {
		...
		OfflineBillQueryModel offlineBillQueryModel=new OfflineBillQueryModel();
	...
	public void testOfflineBillPaymentDetail() {
		...
		String string = yunxinPaymentController.showOfflineBillDetail(offlineBillId, principal,page);
		Result result = JSON.parseObject(string,Result.class );
		Map<String, Object> map = result.getData();
		OfflineBill offlineBill = JSON.parseObject(JSON.toJSONString( map.get("offlineBill")), OfflineBill.class);
		...
		List<OrderMatchShowModel> orderMatchShowModelList = JSON.parseArray(JSON.toJSONString(map.get("orderMatchShowModelList")), OrderMatchShowModel.class);
		assertEquals(2, orderMatchShowModelList.size());
		OrderMatchShowModel orderMatchShowModel_1 = orderMatchShowModelList
				.get(0);
		assertEquals(new Long(1), orderMatchShowModel_1.getOrderId());
		...
		OrderMatchShowModel orderMatchShowModel_2 = orderMatchShowModelList
				.get(1);
		assertEquals(new Long(2), orderMatchShowModel_2.getOrderId());
