...
//			requestParams.put("auditTime", "2016-08-20 00:00:00");
			...
			requestParams.put("remittanceDetails", "[{'detailNo':'detailNo1','recordSn':'1','amount':'" + amount + "','plannedDate':'"+ DateUtils.format(new Date()) +"','bankCode':'C10103','bankCardNo':'" + bankCardNo + "','bankAccountHolder':'测试用户1','bankProvince':'bankProvince1','bankCity':'bankCity1','bankName':'bankName1','idNumber':'idNumber1'}]");
			try {
	...
	public void testApiCommandRemittanceFF() {
		Map<String, String> requestParams = new HashMap<String, String>();
		requestParams.put("fn", "300002");
		requestParams.put("requestNo", "123321231234323212");
		requestParams.put("remittanceStrategy", "0");
		...
		requestParams.put("remittanceDetails",
			"[{'detailNo':'detailNo1','recordSn':'1','amount':'1.11','bankCode':'C10102','bankCardNo':'5685968545868856','bankAccountHolder':'汪水','bankProvince':'bankProvince1','bankCity':'bankCity1','bankName':'bankName1','idNumber':'idNumber1'}"
...
//		String url = "http://101.52.128.166/Loan/PaidNotic";
	...
	public void testApiCommandRemittanceBlackList() {
		...
		requestParams.put("requestNo", UUID.randomUUID().toString());
		requestParams.put("productCode", "G31700");
		requestParams.put("uniqueId", "testwf124");
