...
public class ContractDetail {
	...
	public void copyToContract(App app, Customer customer, House house, Contract contract, FinancialContract financialContract, Date beginingLoanDate) {
		contract.setApp(app);
		...
		contract.setBeginDate(beginingLoanDate);
		...
		contract.setInterestRateCycle(getInterestRateCycle());
		...
		contract.setCustomerUuid(customer.getCustomerUuid());
