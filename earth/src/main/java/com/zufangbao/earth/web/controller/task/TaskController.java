package com.zufangbao.earth.web.controller.task;

import com.demo2do.core.utils.JsonUtils;
import com.zufangbao.earth.task.BasicTask;
...
public class TaskController{
	...
	public String show(HttpServletResponse response) {
		try {
			List<DynamicBusinessTask> tasks = dynamicBusinessTaskService.getDynamicBusinessTaskListByServerGroup(DynamicBusinessTask.SERVER_GROUP_EARTH);
	...
	public String startup(HttpServletResponse response){
		try {
			...
			synchronized(this) {
				...
				List<DynamicBusinessTask> dbTasks = dynamicBusinessTaskService.getDynamicBusinessTaskListByServerGroup(DynamicBusinessTask.SERVER_GROUP_EARTH);
