            ...
            <div class="table-area">
                <table class="data-list" data-action="${ctx}/voucher/active/query" data-autoload="true">
                        <thead>
                            <tr>
                                <th>
                                    <label><input class="check-box check-box-all" type="checkbox" ></label>
                                </th>
                                <th>凭证编号</th>
                                <th>专户账号</th>
                                <th>来往机构名称</th>
                            ...
                            <script type="script/template" id="tableFieldTmpl">
                                {% _.each(list, function(item, index){ %}
                                    <tr data-detail-id="{%= item.id %}">
                                        ...
                                        <td> 
                                            <a href="${ctx}/voucher/active/detail/{%= item.id %}">
                                                {%= item.voucherNo %}
                                            </a>
                                        </td>
                                        ...
                                        <td><a href='${ctx}/voucher/active/detail/resource/{%= item.id %}'>下载</a></td>
