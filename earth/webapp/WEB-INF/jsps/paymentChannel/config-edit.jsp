								...
								<c:if test="${debitChannelWorkingStatus.ordinal != 0}">
									...
									<div class="field-row">
										...
										<div class="field-value">
											...
											<!-- <input type="text" name="trasncationLimitPerTransactionMin" value="{%= debitChannelConfigure.trasncationLimitPerTransactionMin %}" class="form-control real-value small">
											~
											<input type="text" name="trasncationLimitPerTransactionMax" value="{%= debitChannelConfigure.trasncationLimitPerTransactionMax %}" class="form-control real-value small"> -->
											...
											<ul class="upload-files">
												{% if (debitChannelConfigure.bankLimitationFileKey) { %}
													<li class="item" data-filename="{%= debitChannelConfigure.bankLimitationFileName %}" data-filekey="{%= debitChannelConfigure.bankLimitationFileKey %}">
														<span class="filename">{%= debitChannelConfigure.bankLimitationFileName %}</span><a href="#" class="delete-files">删除</a>
													</li>
												{% } %}
											</ul>
								...
								<c:if test="${creditChannelWorkingStatus.ordinal != 0}">
									...
									<div class="field-row">
										...
										<div class="field-value">
											...
											<input type="text" name="trasncationLimitPerTransactionMin" value="{%= creditChannelConfigure.trasncationLimitPerTransactionMin %}" class="form-control real-value small">
											~
											<input type="text" name="trasncationLimitPerTransactionMax" value="{%= creditChannelConfigure.trasncationLimitPerTransactionMax %}" class="form-control real-value small">
											<span class="text-muted">万元/笔</span> 
										</div>
									</div>
									<div class="field-row">
											...
											<ul class="upload-files">
												{% if (creditChannelConfigure.bankLimitationFileKey) { %}
													<li class="item" data-filename="{%= creditChannelConfigure.bankLimitationFileName %}" data-filekey="{%= creditChannelConfigure.bankLimitationFileKey %}">
														<span class="filename">{%= creditChannelConfigure.bankLimitationFileName %}</span><a href="#" class="delete-files">删除</a>
													</li>
												{% } %}
											</ul>
											<span class="file-input btn " data-target=".upload-files">
	            				...
	            				<div class="block">
	            				    ...
	            				    <div class="bd">
	            				        <table class="data-list" 
	            				            ...
	            				            <tbody>
            				            		<script type="script/template" id="limitSheetListTmpl">
            				            	    	{% _.each(list, function(item, index){  %}
            				            	        	<tr>
            				            	        	    <td>{%= item.bankName %}</td>
            				            	        	    <td>{%= item.transactionLimitPerTranscation ? (+item.transactionLimitPerTranscation).formatMoney(2, '') : '--' %}</td>
            				            	        	    <td>{%= item.transcationLimitPerDay ? (+item.transcationLimitPerDay).formatMoney(2, '') : '--' %}</td>
            				            	        	    <td>{%= item.transactionLimitPerMonth ? (+item.transactionLimitPerMonth).formatMoney(2, '') : '--' %}</td>
            				            	        	</tr>
            				            	    	{% }) %}
            				            		</script>
	            				            </tbody>
