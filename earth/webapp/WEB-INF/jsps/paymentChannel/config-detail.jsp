...
<script type="script/template" id="transactionRecord">
    <thead>
        <tr>
            <th>uniqueid</th>
            <th>交易时间</th>
							                ...
							                <ul class="dropdown-menu" role="menu">
								                <li>
								                	<a 
								                		href="#" 
								                		class="export-excel" 
								                		data-action="${ctx}/paymentchannel/config/transactionDetail/export" 
								                		data-preview-action="${ctx}/paymentchannel/config/transactionDetail/preview-export" 
								                		data-preview-template="#transactionRecord"
								                		data-toggle="export">
								                		交易记录
								                	</a>
								                </li>
