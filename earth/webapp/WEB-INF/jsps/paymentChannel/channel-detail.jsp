        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="step-operation no-channel" style="display: none;">
                        <div class="step-tip">
                            <div data-index="1" class="step-tip-item z-active">
                                <div class="ordinal">1</div>
                                <div class="text">选择通道策略</div>
                        ...
                        <div class="step-footer">
                            <button type="button" class="btn btn-default btn-prev prev">取消</button>
                            <button type="button" class="btn btn-primary btn-next next">确定</button>
                        </div>
                    </div>
                </div>
            </div>
                                                ...
                                                {% _.each(list, function(bank, index) { %}
                                                    <tr>
                                                        ...
                                                        {% _.each(bank.paymentChannelList, function(paymentChannel) { %}
                                                            <td class="showPopover"
                                                                data-container="body"
                                                                data-placement="top"
                                                                data-html="true"
                                                                data-trigger="focus" 
                                                                data-toggle="popover"
                                                                data-paymentchanneluuid="{%= paymentChannel.paymentChannelUuid%}"
