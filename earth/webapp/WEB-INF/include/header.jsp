    ...
    <div class="bd">
        ...
        <div class="nav pull-left">
            <ul class="menu">
                ...
                <li class='menu-item ${menu.id} ${menu.id == activeMenu ? "z-active" : ""}'>
                    <a class="real-menu-link" href="${ctx}/${menu.url}">${menu.name}</a>
                </li>
                </sec:authorize> 
                </c:forEach>
            </ul>
        ...
        <div class="profile pull-right">
              ...
              <a class="dropdown-toggle" href="javascript: void 0;" data-toggle="dropdown">
              	<c:if test="${not empty ctx.production}">
             		<span class="company-logo">
	            		<img src="${ctx.resource}/images/company-logo/${ctx.production}.png" alt="">
	          		</span>
              	</c:if>
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                <li class="item-todo"><a href="javascript:void 0;" class="btn-toggle-dashboard">任务单</a></li>
                <li class="item-notice"><a href="javascript:void 0;" class="btn-toggle-dashboard" >公告</a></li>
...
<script type="text/javascript">
    (function (initHeaderFunc) {
        ...
        $el.on('click', '.real-menu-link', function(e) {
            e.preventDefault();
