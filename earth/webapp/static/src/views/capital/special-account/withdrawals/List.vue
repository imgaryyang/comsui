        ...
        <div class="scroller">
                ...
                <el-form class="sdf-form sdf-query-form" :inline="true">
                    ...
                    <el-form-item>
                        <ComboQueryBox v-model="comboConds">
                            <el-option label="提现账户" value="deductPlanNo"></el-option>
                            <el-option label="对方账号" value="deductApplicationNo"></el-option>
                            <el-option label="对方户名" value="customerName"></el-option>
            ...
            <div class="table-area">
                <el-table
                    ...
                    <el-table-column label="提现单号" prop="temporaryDepositDocNo" inline-template>
                        <a :href="`${ctx}#/capital/special-account/withdrawals/${row.temporaryDepositDocUuid}/detail`">{{row.temporaryDepositDocNo }}</a>
                    </el-table-column>
                    <el-table-column :label="$utils.locale('financialContract')" prop="contractName">
                    </el-table-column>
                    <el-table-column label="提现账户" prop="customer">
                    </el-table-column>
