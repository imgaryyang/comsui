<template>
    <div class="content">
        <div class="scroller" v-loading="fetching">
            <Breadcrumb :routes="[{ title: '专户提现凭证'}, { title: '专户提现凭证详情'}]">
            </Breadcrumb>
            ...
            <div class="row-layout-detail">
                ...
                <div class="block">
                    ...
                    <el-table :data="voucherModel">
                        ...
                        <el-table-column prop="paymentName" label="通道请求号">
                        </el-table-column>
