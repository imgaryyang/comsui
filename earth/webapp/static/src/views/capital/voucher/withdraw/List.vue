		...
		<div class="scroller">
			<div class="query-area">
				<el-form class="sdf-form sdf-query-form" :inline="true">
					...
					<el-form-item>
						<el-select size="small" v-model="queryConds.b" placeholder="提现网关" clearable>
					...
					<el-form-item>
						<el-select size="small" v-model="queryConds.c" placeholder="凭证状态" clearable>
					...
					<el-form-item>
						<ComboQueryBox v-model="comboConds">
							<el-option label="提现账户名" value="a"></el-option>
							<el-option label="提现账户号" value="b"></el-option>
						</ComboQueryBox>
					</el-form-item>
					<el-form-item>
			...
			<div class="table-area">
				<el-table
					...
					<el-table-column label="提现账户名" prop="b"></el-table-column>
					<el-table-column label="提现账户号" prop="c"></el-table-column>
					<el-table-column label="提现行别" prop="d"></el-table-column>
					<el-table-column label="提现金额" prop="e"></el-table-column>
					<el-table-column label="提现方式" prop="g"></el-table-column>
					<el-table-column label="凭证来源" prop="f"></el-table-column>
					<el-table-column label="提现网关" prop="i"></el-table-column>
					<el-table-column label="凭证状态" prop="j"></el-table-column>
