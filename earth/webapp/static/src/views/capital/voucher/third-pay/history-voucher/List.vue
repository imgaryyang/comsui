        ...
        <div class="scroller">
            <div class="query-area">
                <el-form class="sdf-form sdf-query-form" :inline="true">
                    ...
                    <el-form-item>
                        <el-button size="small" type="primary" v-if="ifElementGranted('export-thirdparty-payment-voucher')" :disabled="dataSource.size == 0 || dataSource.size == undefined" @click="exportInfo">导出</el-button>
                    </el-form-item>
                </el-form>
            </div>
...
<script>
    ...
    export default {
        ...
        data: function() {
            return {
                action: '/voucher/thirdPartyPayApi/list',
                pageConds: {
        ...
        methods: {
            ...
            exportInfo: function(){
                var queryConds = Object.assign({},this.queryConds,this.comboConds);
                downloadFile(`/report/export?reportId=17`,filterQueryConds(queryConds));
            }
        }
    }
</script>