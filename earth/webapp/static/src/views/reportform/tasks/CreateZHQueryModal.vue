        ...
        data: function() {
            return {
                ...
                rules: {
                    ...
                    financialContractUuids: {required: true, message: ' ',trigger: 'change'},
            ...
            submit: function() {
                this.$refs.form.validate(valid => {
                    if (valid) {
                        ...
                        // data.financialContractUuids = this.isAvictc ? data.financialContractUuids : JSON.stringify(data.financialContractUuids);
                        ajaxPromise({
                            url: `/zh/report/jobs/`,
                            data: this.model,
                            type: 'POST'
                            ...
                            this.show = false;
                            MessageBox.open(`${this.model.reportId == 0 ? '放款还款报表任务创建成功！' : '专户流水报表任务创建成功！'}`);
