define(function(require, exports, module) {
    ...
    var PageControl = Backbone.View.extend({
        ...
        render: function() {
            ...
            if (totalPageNum === 1 || this.isGteTotalPageNum(this.pageIndex, true) || (this.curPageRecordNum != null && this.curPageRecordNum < this.pageRecordNum)) {
        ...
        getData: function(search, type, callback) {
            ...
            opt.success = function(resp, textStatus, xhr) {
                if (resp.code == 0) {
                    ...
                    that.trigger('pagecontrol:bad', resp);
                }
            };
